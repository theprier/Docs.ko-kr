...
<span data-ttu-id="2337f-103">[이전 - 모델 추가](adding-model.md)
[다음 - 컨트롤러 메서드 및 보기](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="2337f-103">[Previous - Add a model](adding-model.md)
