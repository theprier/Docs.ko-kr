...
<span data-ttu-id="67b66-124">두 가지 방법으로이 위해 수를 살펴 보겠습니다.</span><span class="sxs-lookup"><span data-stu-id="67b66-124">Let's look at two ways we can accomplish this.</span></span>
