...
> <span data-ttu-id="9406d-103">[이전: 페이지 업데이트](xref:tutorials/razor-pages-vsc/da1)
> [다음: 새 필드 추가](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="9406d-103">[Previous: Updating the pages](xref:tutorials/razor-pages-vsc/da1)
