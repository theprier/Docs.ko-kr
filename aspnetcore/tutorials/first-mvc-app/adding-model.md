...
<!-- following image shared with uid: tutorials/razor-pages/model --> ![PMC 메뉴](adding-model/_static/pmc.png)
...
`Update-Database` 명령은 *Migrations/\<time-stamp>_Initial.cs* 파일에서 데이터베이스를 만드는 `Up` 메서드를 실행합니다.
