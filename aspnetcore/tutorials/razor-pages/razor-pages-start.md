...
이 시리즈의 첫 번째 자습서입니다. [시리즈](xref:tutorials/razor-pages/index)에서는 ASP.NET Core Razor Pages 웹앱을 빌드하는 작업의 기본 사항을 설명합니다. 시리즈가 끝나면 영화의 데이터베이스를 관리하는 앱이 생성됩니다.  
...
## <a name="run-the-web-app"></a>웹 앱 실행
