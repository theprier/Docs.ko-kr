...
[URL 재작성 샘플 앱](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/url-rewriting/samples/)을 사용하여 URL 재작성 미들웨어의 기능을 탐색할 수 있습니다. 앱은 재작성 및 리디렉션 규칙을 적용하고 재작성 또는 리디렉션된 URL을 보여 줍니다.
