...
이 샘플의 사용자 권한 부여 기능에 설명 하는 쿠키 인증을 사용 하는 [ASP.NET Core Id 없이 쿠키 인증을 사용 하 여](https://docs.microsoft.com/aspnet/core/security/authentication/cookie) 항목입니다. ASP.NET Core Id를 사용 하는 방법은 항목을 참조는 [인증](https://docs.microsoft.com/aspnet/core/security/authentication/index) 설명서의 섹션입니다.
