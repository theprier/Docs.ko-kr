...
| Java 클라이언트 | [GitHub 리포지토리](https://github.com/SignalR/java-client) (사용 되지 않음)  | Maven 패키지 [com.microsoft.signalr](https://search.maven.org/artifact/com.microsoft.signalr/signalr) |
