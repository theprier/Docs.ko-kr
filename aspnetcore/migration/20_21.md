...
* 참조 프로젝트 `Microsoft.AspNetCore.All` 또는 `Microsoft.AspNetCore.App` 패키지를 참조 해야 `Microsoft.Net.Sdk.Web` Sdk입니다.
* 패키지 또는 전이적으로 참조 하는 프로젝트를 참조 하는 프로젝트 `Microsoft.AspNetCore.All` 또는 `Microsoft.AspNetCore.App`:
  * 참조 해야 합니다는 `Microsoft.Net.Sdk.Web` Sdk 하 고,
  * 동일한 공유 런타임 패키지를 참조 해야 합니다. 예를 들어, LibraryA 참조 하는 경우 `Microsoft.AspNetCore.App`를 참조 하는 프로젝트를 참조 해야 `Microsoft.AspNetCore.App`합니다.
* 실행 파일 프로젝트의 경우:
  * 으로 시작 하는 앱을 포함 하는 프로젝트는 `dotnet run`합니다.
  * 실행 하 고 응용 프로그램 프로젝트를 테스트 하는 응용 프로그램.
  * 실행 파일 프로젝트의 버전을 지정 해야 합니다. Sdk를 통해 암시적으로 버전 지정 `<PackageReference Include="Microsoft.AspNetCore.App" />`합니다.
* 참조 된 프로젝트입니다.
  * 진입점이 아닌 프로젝트 및
  * 프로젝트 참조 `Microsoft.AspNetCore.All` 또는 `Microsoft.AspNetCore.App`합니다.
  * 참조 된 프로젝트 패키지 버전을 지정 해야 합니다.
