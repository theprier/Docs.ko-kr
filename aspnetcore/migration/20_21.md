...
* Identity UI 2.0 코드 변경 없이 사용 합니다. Identity UI 2.0 코드를 사용 하 여 완전히 지원 됩니다. 생성된 된 Identity 코드에 되었으며 변경 사항이 생겼는지 경우 이것이 좋은 방법입니다.
...
* 생성 된 Identity 스 캐 폴더를 삭제 `IdentityDbContext` 에서 파생 됩니다 클래스는 *영역/Id/데이터/* 폴더입니다.
* 삭제 *Areas/Identity/IdentityHostingStartup.cs*
* 업데이트를 *_LoginPartial.cshtml* 파일:
  * 이동할 *Pages/_LoginPartial.cshtml* 에 *Pages/Shared/_LoginPartial.cshtml*
...
* 이동할 *pages/_layout.cshtml* 에 *Pages/Shared/_Layout.cshtml*
...
* *_Validationscriptspartial.cshtml* 이동 *Pages/Shared/_ValidationScriptsPartial.cshtml*
