...
* [Visual Studio를 사용하여 ASP.NET Core MVC로 첫 번째 Web API 빌드](../../tutorials/first-web-api.md)
...
* [응답 데이터 서식 지정](../models/formatting.md)
* [사용자 지정 서식 지정기](../advanced/custom-formatters.md)
