...
따라서 클라이언트 쪽 유효성 검사는 폼이 유효한 될 때까지 전송을 방지 합니다. 제출 단추가 양식을 전송 또는 오류 메시지를 표시 하는 JavaScript를 실행 합니다.
...
### <a name="adding-validation-to-dynamic-forms"></a>동적 양식을에 유효성 검사를 추가 합니다.
...
### <a name="adding-validation-to-dynamic-controls"></a>동적 컨트롤에 유효성 검사를 추가 합니다.
