...
| 기능 | 샘플 데모 |
| -------- | ----------- |
| [경로 및 앱 규칙 추가](https://docs.microsoft.com/aspnet/core/mvc/razor-pages/razor-pages-convention-features#add-route-and-app-model-conventions) | 앱의 페이지에 경로 특성 및 헤더를 추가합니다. |
