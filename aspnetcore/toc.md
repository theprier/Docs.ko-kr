...
## [Azure 저장소](data/azure-storage/index.md)
...
### [CLI 도구를 사용하여 Azure에 게시](/azure/app-service/app-service-web-get-started-dotnet)
...
### [외부 공급자](xref:security/authentication/social/index)
