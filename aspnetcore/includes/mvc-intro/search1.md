...
`Index` 작업 메서드의 첫 번째 줄은 영화를 선택하는 [LINQ](https://docs.microsoft.com/dotnet/standard/using-linq) 쿼리를 만듭니다.
