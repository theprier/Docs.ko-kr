## <a name="register-the-database-context"></a><span data-ttu-id="526d4-101">데이터베이스 컨텍스트 등록</span><span class="sxs-lookup"><span data-stu-id="526d4-101">Register the database context</span></span>
