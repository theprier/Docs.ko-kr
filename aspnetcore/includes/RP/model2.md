...
*MovieContext.cs*라는 다음 `DbContext` 파생 클래스를 *Models* 폴더에 추가합니다.[!code-csharp[Main](../../tutorials/razor-pages/razor-pages-start/snapshot_sample/RazorPagesMovie/Models/MovieContext.cs)]
