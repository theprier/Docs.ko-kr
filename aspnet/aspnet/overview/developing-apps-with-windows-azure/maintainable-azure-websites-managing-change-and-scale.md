...
<span data-ttu-id="5b8ad-163">이 랩을 완료 하기 위한 예상 시간: **75 분**</span><span class="sxs-lookup"><span data-stu-id="5b8ad-163">Estimated time to complete this lab: **75 minutes**</span></span>
...
1. <span data-ttu-id="5b8ad-221">**솔루션 탐색기**를 두 번 클릭 합니다 **TriviaQuestion.cs** 내에 있는 파일을 **모델** 폴더.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-221">In **Solution Explorer**, double-click the **TriviaQuestion.cs** file located inside the **Models** folder.</span></span>
...
11. <span data-ttu-id="5b8ad-246">**SQL Server 개체 탐색기**, 새로 고침을 **dbo입니다. TriviaQuestions** 테이블 및 있는지 여부를 확인 합니다 **힌트** 열 형식이 **nvarchar(150)** 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-246">In **SQL Server Object Explorer**, refresh the **dbo.TriviaQuestions** table and check that the **Hint** column type is **nvarchar(150)**.</span></span>
    ...
    <span data-ttu-id="5b8ad-248">*새 제약 조건을 보여 주는*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-248">*Showing the new constraint*</span></span>
...
5. <span data-ttu-id="5b8ad-277">데이터베이스 설정에 대 한 다음 정보를 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-277">Specify the following information for the database settings:</span></span>
   ...
   - <span data-ttu-id="5b8ad-278">에 **이름을** 텍스트 상자에 데이터베이스 이름을 입력 합니다 (예: *geekquiz\_db*)</span><span class="sxs-lookup"><span data-stu-id="5b8ad-278">In the **Name** text box, enter a database name (e.g. *geekquiz\_db*)</span></span>
...
2. <span data-ttu-id="5b8ad-310">에 **대시보드** 페이지에서 **연결 문자열 보기** 링크를 **눈** 섹션입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-310">In the **Dashboard** page, click **View connection strings** link under the **quick glance** section.</span></span>
    ...
    <span data-ttu-id="5b8ad-312">*연결 문자열 보기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-312">*View connection strings*</span></span>
...
7. <span data-ttu-id="5b8ad-325">에 **허용 된 IP 주소** 섹션을 클릭 **허용 되는 IP 주소를 추가할** IP SQL Database 서버에 연결할 수 있도록 링크 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-325">In the **Allowed IP addresses** section, click on **Add to the allowed IP addresses** link to enable your IP to connect to the SQL Database server.</span></span>
    ...
    <span data-ttu-id="5b8ad-327">*허용 된 IP 주소*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-327">*Allowed IP addresses*</span></span>
...
12. <span data-ttu-id="5b8ad-381">클릭 **배포** 보려는 합니다 **배포 기록**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-381">Click **Deployments** to see the **deployment history**.</span></span> <span data-ttu-id="5b8ad-382">있는지 확인 하십시오는 **활성 배포가** 사용 하 여 프로그램  *&quot;초기 커밋&quot;* 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-382">Verify that there is an **Active Deployment** with your *&quot;Initial Commit&quot;*.</span></span>

    ![활성 배포](maintainable-azure-websites-managing-change-and-scale/_static/image40.png)

    <span data-ttu-id="5b8ad-384">*활성 배포*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-384">*Active deployment*</span></span>
13. <span data-ttu-id="5b8ad-385">마지막으로, 클릭 **찾아보기** 웹 앱으로 이동 하려면 명령 모음에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-385">Finally, click **Browse** in the command bar to go to the web app.</span></span>

    ![웹 앱 찾아보기](maintainable-azure-websites-managing-change-and-scale/_static/image41.png)

    <span data-ttu-id="5b8ad-387">*웹 앱 찾아보기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-387">*Browse web app*</span></span>
14. <span data-ttu-id="5b8ad-388">응용 프로그램을 성공적으로 배포한 경우 Geek 퀴즈 로그인 페이지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-388">If the application is successfully deployed, you will see the Geek Quiz login page.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-389">배포 된 응용 프로그램의 주소 URL은 뒤에 웹 앱의 이름을 포함 *-스테이징*합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-389">The address URL of the deployed application contains the name of your web app followed by *-staging*.</span></span>

    ![스테이징 환경에서 실행 중인 응용 프로그램](maintainable-azure-websites-managing-change-and-scale/_static/image42.png)

    <span data-ttu-id="5b8ad-391">*스테이징 환경에서 실행 중인 응용 프로그램*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-391">*Application running in the staging environment*</span></span>
15. <span data-ttu-id="5b8ad-392">응용 프로그램을 탐색 하려는 경우 클릭 **등록** 새 사용자를 등록 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-392">If you wish to explore the application, click **Register** to register a new user.</span></span> <span data-ttu-id="5b8ad-393">사용자 이름, 전자 메일 주소 및 암호를 입력 하 여 계정 세부 정보를 완료 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-393">Complete the account details by entering a user name, email address and password.</span></span> <span data-ttu-id="5b8ad-394">다음으로, 응용 프로그램에서는 퀴즈의 첫 번째 질문을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-394">Next, the application shows the first question of the quiz.</span></span> <span data-ttu-id="5b8ad-395">이 예상 대로 작동 하는지 확인 하려면 몇 가지 질문에 답변 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-395">Answer a few questions to make sure it is working as expected.</span></span>

    ![응용 프로그램을 사용할 준비가 되었습니다.](maintainable-azure-websites-managing-change-and-scale/_static/image43.png)

    <span data-ttu-id="5b8ad-397">*응용 프로그램을 사용할 준비가 되었습니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-397">*Application ready to be used*</span></span>

<a id="Ex2Task4"></a>
#### <a name="task-4--promoting-the-web-app-to-production"></a><span data-ttu-id="5b8ad-398">작업 4-프로덕션 웹 앱을 승격 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-398">Task 4 – Promoting the Web App to Production</span></span>

<span data-ttu-id="5b8ad-399">웹 앱 스테이징 환경에서 제대로 작동 하는지 확인 했으므로 프로덕션으로 승격할 준비가 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-399">Now that you have verified that the web app is working correctly in the staging environment, you are ready to promote it to production.</span></span> <span data-ttu-id="5b8ad-400">이 태스크에서는 프로덕션 사이트 슬롯을 사용 하 여 스테이징 사이트 슬롯을 교환 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-400">In this task, you will swap the staging site slot with the production site slot.</span></span>

1. <span data-ttu-id="5b8ad-401">관리 포털에 다시 이동 하 고 스테이징 사이트 슬롯을 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-401">Go back to the management portal and select the staging site slot.</span></span> <span data-ttu-id="5b8ad-402">클릭 **교환** 명령 모음에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-402">Click **Swap** in the command bar.</span></span>

    ![프로덕션으로 교환](maintainable-azure-websites-managing-change-and-scale/_static/image44.png)

    <span data-ttu-id="5b8ad-404">*프로덕션으로 교환*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-404">*Swap to production*</span></span>
2. <span data-ttu-id="5b8ad-405">클릭 **예** 스왑 작업을 계속 하려면 확인 대화 상자에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-405">Click **Yes** in the confirmation dialog box to proceed with the swap operation.</span></span> <span data-ttu-id="5b8ad-406">Azure가 즉시 스테이징 사이트의 콘텐츠를 사용 하 여 프로덕션 사이트의 콘텐츠를 교환 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-406">Azure will immediately swap the content of the production site with the content of the staging site.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-407">일부 설정은 준비 된 버전에서 프로덕션 버전 (예: 연결 문자열 재정의 처리기 매핑 등)에 자동으로 복사 됩니다 있지만 (예: DNS 끝점, SSL 바인딩 등)에 다른 설정은 변경 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-407">Some settings from the staged version will automatically be copied to the production version (e.g. connection string overrides, handler mappings, etc.) but other settings will not change (e.g. DNS endpoints, SSL bindings, etc.).</span></span>

    ![교환 작업 확인](maintainable-azure-websites-managing-change-and-scale/_static/image45.png)

    <span data-ttu-id="5b8ad-409">*교환 작업 확인*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-409">*Confirming swap operation*</span></span>
3. <span data-ttu-id="5b8ad-410">교체가 완료 되 면 프로덕션 슬롯을 선택 하 고 클릭 **찾아보기** 프로덕션 사이트를 열려면 명령 모음에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-410">Once the swap is complete, select the production slot and click **Browse** in the command bar to open the production site.</span></span> <span data-ttu-id="5b8ad-411">주소 표시줄에 URL을 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-411">Notice the URL in the address bar.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-412">캐시의 선택을 취소 하려면 브라우저를 새로 고침 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-412">You might need to refresh your browser to clear cache.</span></span> <span data-ttu-id="5b8ad-413">Internet Explorer에서 하면이 키를 눌러 **CTRL + R**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-413">In Internet Explorer, you can do this by pressing **CTRL+R**.</span></span>

    ![프로덕션 환경에서 실행 중인 웹 앱](maintainable-azure-websites-managing-change-and-scale/_static/image46.png)
4. <span data-ttu-id="5b8ad-415">에 **GitBash** 콘솔에서 프로덕션 슬롯을 대상으로 로컬 Git 리포지토리에 대 한 원격 URL을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-415">In the **GitBash** console, update the remote URL for the local Git repository to target the production slot.</span></span> <span data-ttu-id="5b8ad-416">이 위해 배포 사용자 이름을 웹 앱의 이름을 사용 하 여 자리 표시자를 대체 하는 다음 명령을 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-416">To do this, run the following command replacing the placeholders with your deployment username and the name of your web app.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-417">다음 실습에서 랩의 단순성에 대 한 스테이징 대신 프로덕션 사이트에 변경 내용을 푸시할 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-417">In the following exercises, you will push changes to the production site instead of staging just for the simplicity of the lab.</span></span> <span data-ttu-id="5b8ad-418">실제 시나리오에서 프로덕션으로 수준을 올리기 전에 스테이징 환경에서 변경 내용을 확인 하는 것이 좋습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-418">In a real-world scenario, it is recommended to verify the changes in the staging environment before promoting to production.</span></span>

    [!code-console[Main](maintainable-azure-websites-managing-change-and-scale/samples/sample13.cmd)]

<a id="Exercise3"></a>
### <a name="exercise-3-performing-deployment-rollback-in-production"></a><span data-ttu-id="5b8ad-419">연습 3: 프로덕션 환경에서 배포 롤백 수행</span><span class="sxs-lookup"><span data-stu-id="5b8ad-419">Exercise 3: Performing Deployment Rollback in Production</span></span>

<span data-ttu-id="5b8ad-420">시나리오가 없는 없는 스테이징과 프로덕션, 예를 들어 간에 핫 스왑 하는 데 스테이징 슬롯을 사용 하는 경우 **무료** 하거나 **공유** 모드입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-420">There are scenarios where you do not have a staging slot to perform hot swap between staging and production, for example, if you are working with **Free** or **Shared** mode.</span></span> <span data-ttu-id="5b8ad-421">이러한 시나리오에서는 테스트 해야 테스트 환경에서 응용 프로그램-로컬 또는 원격 사이트에 – 프로덕션에 배포 하기 전에 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-421">In those scenarios, you should test your application in a testing environment –either locally or in a remote site– before deploying to production.</span></span> <span data-ttu-id="5b8ad-422">그러나 가능성이 프로덕션 사이트에서 테스트 단계 중에 검색 되지 문제가 발생할 수는 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-422">However, it is possible that an issue not detected during the testing phase may arise in the production site.</span></span> <span data-ttu-id="5b8ad-423">이 예제의 경우 쉽게 응용 프로그램의 이전 및 더 안정적인 버전으로 가능한 한 빨리 전환 하는 메커니즘을 마련해 야 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-423">In this case, it is important to have a mechanism to easily switch to a previous and more stable version of the application as quickly as possible.</span></span>

<span data-ttu-id="5b8ad-424">**Azure App Service**, 소스 제어의 연속 배포를 통해이 가능한 감사 인사를 전 합니다 **재배포** 관리 포털에서 사용할 수 있는 작업입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-424">In **Azure App Service**, continuous deployment from source control makes this possible thanks to the **redeploy** action available in the management portal.</span></span> <span data-ttu-id="5b8ad-425">Azure 연결 된 리포지토리에 푸시된 커밋과 배포를 추적 하 고 이전 배포를 사용 하 여 언제 든 지 응용 프로그램을 다시 배포 하는 옵션을 제공 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-425">Azure keeps track of the deployments associated with the commits pushed to the repository and provides an option to redeploy your application using any of your previous deployments, at any time.</span></span>

<span data-ttu-id="5b8ad-426">이 연습에서는 코드에 대 한 변경 수행 합니다 **Geek 퀴즈** 의도적으로 삽입 하는 응용 프로그램을 *버그*합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-426">In this exercise you will perform a change to the code in the **Geek Quiz** application that intentionally injects a *bug*.</span></span> <span data-ttu-id="5b8ad-427">오류를 확인 하려면 프로덕션 환경에 응용 프로그램 배포 및 다음 있습니다 이용 하는 이전 상태로 다시 이동 하는 재배포 기능.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-427">You will deploy the application to production to see the error, and then you will take advantage of the redeploy feature to go back to the previous state.</span></span>

<a id="Ex3Task1"></a>
#### <a name="task-1--updating-the-geek-quiz-application"></a><span data-ttu-id="5b8ad-428">작업 1-Geek 퀴즈 응용 프로그램 업데이트</span><span class="sxs-lookup"><span data-stu-id="5b8ad-428">Task 1 – Updating the Geek Quiz Application</span></span>

<span data-ttu-id="5b8ad-429">이 태스크에서는 코드의 작은 조각을 리팩터링 합니다 **TriviaController** 클래스의 새 메서드로 데이터베이스에서 선택한 퀴즈 옵션을 검색 하는 논리 부분을 추출 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-429">In this task, you will refactor a small piece of code of the **TriviaController** class to extract part of the logic that retrieves the selected quiz option from the database into a new method.</span></span>

1. <span data-ttu-id="5b8ad-430">사용 하 여 Visual Studio 인스턴스를 전환 합니다 **GeekQuiz** 이전 연습에서 솔루션입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-430">Switch to the Visual Studio instance with the **GeekQuiz** solution from the previous exercise.</span></span>
2. <span data-ttu-id="5b8ad-431">**솔루션 탐색기**오픈를 **TriviaController.cs** 파일을 **컨트롤러** 폴더.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-431">In **Solution Explorer**, open the **TriviaController.cs** file inside the **Controllers** folder.</span></span>
3. <span data-ttu-id="5b8ad-432">찾을 합니다 **StoreAsync** 메서드와 다음 그림에 강조 표시 된 코드를 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-432">Locate the **StoreAsync** method and select the code highlighted in the following figure.</span></span>

    ![코드를 선택합니다.](maintainable-azure-websites-managing-change-and-scale/_static/image47.png)

    <span data-ttu-id="5b8ad-434">*코드를 선택합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-434">*Selecting the code*</span></span>
4. <span data-ttu-id="5b8ad-435">확장 하 고, 선택한 코드를 마우스 오른쪽 단추로 클릭 합니다 **리팩터링** 선택한 메뉴 **메서드 추출...** .</span><span class="sxs-lookup"><span data-stu-id="5b8ad-435">Right-click the selected code, expand the **Refactor** menu and select **Extract Method...**.</span></span>

    ![새 메서드로 코드를 추출합니다.](maintainable-azure-websites-managing-change-and-scale/_static/image48.png)

    <span data-ttu-id="5b8ad-437">*Extract 메서드를 선택합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-437">*Selecting Extract Method*</span></span>
5. <span data-ttu-id="5b8ad-438">에 **메서드 추출** 대화 상자에서 새 메서드 이름 *MatchesOption* 클릭 **확인**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-438">In the **Extract Method** dialog box, name the new method *MatchesOption* and click **OK**.</span></span>

    ![메서드 이름을 지정합니다.](maintainable-azure-websites-managing-change-and-scale/_static/image49.png)

    <span data-ttu-id="5b8ad-440">*추출한 메서드에 대 한 이름을 지정합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-440">*Specifying the name for the extracted method*</span></span>
6. <span data-ttu-id="5b8ad-441">선택한 코드를 다음으로 추출 합니다 **MatchesOption** 메서드.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-441">The selected code is then extracted into the **MatchesOption** method.</span></span> <span data-ttu-id="5b8ad-442">결과 코드는 다음 코드 조각에 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-442">The resulting code is shown in the following snippet.</span></span>

    [!code-csharp[Main](maintainable-azure-websites-managing-change-and-scale/samples/sample14.cs)]
7. <span data-ttu-id="5b8ad-443">키를 눌러 **CTRL + S** 변경 내용을 저장 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-443">Press **CTRL + S** to save the changes.</span></span>

<a id="Ex3Task2"></a>
#### <a name="task-2--redeploying-the-geek-quiz-application"></a><span data-ttu-id="5b8ad-444">작업 2-Geek 퀴즈 응용 프로그램을 재배포</span><span class="sxs-lookup"><span data-stu-id="5b8ad-444">Task 2 – Redeploying the Geek Quiz Application</span></span>

<span data-ttu-id="5b8ad-445">이제 프로덕션 환경에 새 배포를 트리거할 리포지토리에 이전 태스크에서 수행한 변경 내용을 푸시할가 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-445">You will now push the changes you made in the previous task to the repository, which will trigger a new deployment to the production environment.</span></span> <span data-ttu-id="5b8ad-446">사용 하 여 문제를 트러블 슈팅는 그런 다음 합니다 **F12 개발 도구** Internet Explorer에서 제공 하 고 Azure 관리 포털에서 롤백 이전 배포를 수행 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-446">Then, you will troubleshot an issue using the **F12 development tools** provided by Internet Explorer, and then perform a rollback to the previous deployment from the Azure management portal.</span></span>

1. <span data-ttu-id="5b8ad-447">새 **Git Bash** Azure App Service에 대 한 업데이트 된 응용 프로그램을 배포 하는 콘솔입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-447">Open a new **Git Bash** console to deploy the updated application to Azure App Service.</span></span>
2. <span data-ttu-id="5b8ad-448">Azure에 변경 내용을 적용 하려면 다음 명령을 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-448">Execute the following commands to push the changes to Azure.</span></span> <span data-ttu-id="5b8ad-449">업데이트를 *[YOUR 응용 프로그램 경로]* 에 대 한 경로 사용 하 여 자리 표시자를 **GeekQuiz** 솔루션입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-449">Update the *[YOUR-APPLICATION-PATH]* placeholder with the path to the **GeekQuiz** solution.</span></span> <span data-ttu-id="5b8ad-450">배포 암호에 대 한 라는 메시지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-450">You will be prompted for your deployment password.</span></span>

    [!code-console[Main](maintainable-azure-websites-managing-change-and-scale/samples/sample15.cmd)]

    ![리팩터링된 코드에서 Azure로 푸시](maintainable-azure-websites-managing-change-and-scale/_static/image50.png)

    <span data-ttu-id="5b8ad-452">*리팩터링된 코드에서 Azure로 푸시*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-452">*Pushing refactored code to Azure*</span></span>
3. <span data-ttu-id="5b8ad-453">Internet Explorer를 열고 웹 앱으로 이동 (예: `http://<your-web-site>.azurewebsites.net`).</span><span class="sxs-lookup"><span data-stu-id="5b8ad-453">Open Internet Explorer and navigate to your web app (e.g. `http://<your-web-site>.azurewebsites.net`).</span></span> <span data-ttu-id="5b8ad-454">이전에 만든된 자격 증명을 사용 하 여 로그인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-454">Log in using the previously created credentials.</span></span>
4. <span data-ttu-id="5b8ad-455">키를 눌러 **F12** 개발 도구를 시작 하려면 합니다 **네트워크** 탭을 클릭 합니다 **재생** 기록을 시작 하려면 단추입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-455">Press **F12** to launch the development tools, select the **Network** tab and click the **Play** button to start recording.</span></span>

    <span data-ttu-id="5b8ad-456">![네트워크 기록 시작](maintainable-azure-websites-managing-change-and-scale/_static/image51.png "네트워크 녹음/녹화 시작")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-456">![Starting network recording](maintainable-azure-websites-managing-change-and-scale/_static/image51.png "Starting network recording")</span></span>

    <span data-ttu-id="5b8ad-457">*네트워크 녹음/녹화 시작*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-457">*Starting network recording*</span></span>
5. <span data-ttu-id="5b8ad-458">퀴즈의 옵션을 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-458">Select any option of the quiz.</span></span> <span data-ttu-id="5b8ad-459">아무 작업도 볼 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-459">You will see that nothing happens.</span></span>
6. <span data-ttu-id="5b8ad-460">에 **F12** 창에서 POST HTTP 요청에 해당 항목은 HTTP를 보여 줍니다 **500** 결과입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-460">In the **F12** window, the entry corresponding to the POST HTTP request shows an HTTP **500** result.</span></span>

    ![HTTP 500 오류](maintainable-azure-websites-managing-change-and-scale/_static/image52.png)

    <span data-ttu-id="5b8ad-462">*HTTP 500 오류*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-462">*HTTP 500 error*</span></span>
7. <span data-ttu-id="5b8ad-463">선택 된 **콘솔** 탭 합니다. 오류 원인의 세부 정보를 사용 하 여 기록 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-463">Select the **Console** tab. An error is logged with the details of the cause.</span></span>

    ![로그인된 오류](maintainable-azure-websites-managing-change-and-scale/_static/image53.png)

    <span data-ttu-id="5b8ad-465">*로그인된 오류*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-465">*Logged error*</span></span>
8. <span data-ttu-id="5b8ad-466">오류 세부 정보 부분을 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-466">Locate the details part of the error.</span></span> <span data-ttu-id="5b8ad-467">물론이 오류는 이전 단계에서 커밋된 있습니다 리팩터링 코드에서 발생 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-467">Clearly, this error is caused by the code refactoring you committed in the previous steps.</span></span>

    <span data-ttu-id="5b8ad-468">`Details: LINQ to Entities does not recognize the method 'Boolean MatchesOption ...`.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-468">`Details: LINQ to Entities does not recognize the method 'Boolean MatchesOption ...`.</span></span>
9. <span data-ttu-id="5b8ad-469">브라우저를 닫지 마세요.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-469">Do not close the browser.</span></span>
10. <span data-ttu-id="5b8ad-470">새 브라우저 인스턴스를 이동 합니다 [Azure 관리 포털](https://manage.windowsazure.com) 구독과 연결 된 Microsoft 계정을 사용 하 여 로그인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-470">In a new browser instance, navigate to the [Azure management portal](https://manage.windowsazure.com) and sign in using the Microsoft account associated with your subscription.</span></span>
11. <span data-ttu-id="5b8ad-471">선택 **Websites** 연습 2에서 만든 웹 앱을 클릭 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-471">Select **Websites** and click the web app you created in Exercise 2.</span></span>
12. <span data-ttu-id="5b8ad-472">로 이동 합니다 **배포** 페이지입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-472">Navigate to the **Deployments** page.</span></span> <span data-ttu-id="5b8ad-473">모든 커밋을 수행 하는 배포 기록에 나열 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-473">Notice that all the commits performed are listed in the deployment history.</span></span>

    ![기존 배포의 목록](maintainable-azure-websites-managing-change-and-scale/_static/image54.png)

    <span data-ttu-id="5b8ad-475">*기존 배포의 목록*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-475">*List of existing deployments*</span></span>
13. <span data-ttu-id="5b8ad-476">이전 커밋을 선택 하 고 클릭 **재배포** 명령 모음에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-476">Select the previous commit and click **Redeploy** on the command bar.</span></span>

    ![이전 커밋 재배포](maintainable-azure-websites-managing-change-and-scale/_static/image55.png)

    <span data-ttu-id="5b8ad-478">*이전 커밋 재배포*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-478">*Redeploying the previous commit*</span></span>
14. <span data-ttu-id="5b8ad-479">확인 대화 상자가 나타나면 클릭 **예**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-479">When prompted to confirm, click **Yes**.</span></span>

    ![재배포를 확인합니다.](maintainable-azure-websites-managing-change-and-scale/_static/image56.png)
15. <span data-ttu-id="5b8ad-481">배포가 완료 되 면 웹 앱 및 키를 눌러 브라우저 인스턴스를 다시 전환 **ctrl+f5**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-481">When the deployment completes, switch back to the browser instance with your web app and press **CTRL + F5**.</span></span>
16. <span data-ttu-id="5b8ad-482">옵션 중 하나를 클릭 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-482">Click any of the options.</span></span> <span data-ttu-id="5b8ad-483">위치 및 결과 플립 애니메이션이 수행 됩니다 (*수정/잘못 된*) 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-483">The flip animation will now take place and the result (*correct/incorrect*) will be displayed.</span></span>
17. <span data-ttu-id="5b8ad-484">(선택 사항) 으로 전환 합니다 **Git Bash** 콘솔 및 이전 커밋으로 되돌리려면 다음 명령을 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-484">(Optional) Switch to the **Git Bash** console and execute the following commands to revert to the previous commit.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-485">이러한 명령에 잘못 된 커밋의 Git 리포지토리에 모든 변경 내용을 실행 취소 하는 새 커밋이 만들어집니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-485">These commands create a new commit that undoes all changes in the Git repository that were made in the bad commit.</span></span> <span data-ttu-id="5b8ad-486">Azure 새 커밋을 사용 하 여 응용 프로그램을 재배포 후 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-486">Azure will then redeploy the application using the new commit.</span></span>

    [!code-console[Main](maintainable-azure-websites-managing-change-and-scale/samples/sample16.cmd)]

<a id="Exercise4"></a>
### <a name="exercise-4-scaling-using-azure-storage"></a><span data-ttu-id="5b8ad-487">실습 4: Azure Storage를 사용 하 여 확장</span><span class="sxs-lookup"><span data-stu-id="5b8ad-487">Exercise 4: Scaling Using Azure Storage</span></span>

<span data-ttu-id="5b8ad-488">**Blob** 많은 양의 구조화 되지 않은 텍스트 또는 비디오, 오디오 및 이미지와 같은 이진 데이터를 저장 하는 가장 간단한 방법입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-488">**Blobs** are the simplest way to store large amounts of unstructured text or binary data such as video, audio and images.</span></span> <span data-ttu-id="5b8ad-489">저장소에 응용 프로그램의 정적 콘텐츠를 이동, 브라우저에 직접 이미지 또는 문서를 제공 함으로써 응용 프로그램을 확장할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-489">Moving the static content of your application to Storage, helps to scale your application by serving images or documents directly to the browser.</span></span>

<span data-ttu-id="5b8ad-490">이 연습에서는 Blob 컨테이너에 응용 프로그램의 정적 콘텐츠를 이동 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-490">In this exercise, you will move the static content of your application to a Blob container.</span></span> <span data-ttu-id="5b8ad-491">추가할 응용 프로그램을 구성 하는 다음을 **ASP.NET URL 재작성 규칙** 에 **Web.config** Blob 컨테이너에 콘텐츠를 리디렉션할 수입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-491">Then you will configure your application to add an **ASP.NET URL rewrite rule** in the **Web.config** to redirect your content to the Blob container.</span></span>

<a id="Ex4Task1"></a>
#### <a name="task-1--creating-an-azure-storage-account"></a><span data-ttu-id="5b8ad-492">작업 1-Azure Storage 계정 만들기</span><span class="sxs-lookup"><span data-stu-id="5b8ad-492">Task 1 – Creating an Azure Storage Account</span></span>

<span data-ttu-id="5b8ad-493">이 작업을 관리 포털을 사용 하 여 새 저장소 계정을 만드는 방법을 배웁니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-493">In this task you will learn how to create a new storage account using the management portal.</span></span>

1. <span data-ttu-id="5b8ad-494">로 이동 합니다 [Azure 관리 포털](https://manage.windowsazure.com) 구독과 연결 된 Microsoft 계정을 사용 하 여 로그인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-494">Navigate to the [Azure management portal](https://manage.windowsazure.com) and sign in using the Microsoft account associated with your subscription.</span></span>
2. <span data-ttu-id="5b8ad-495">선택 **새 | Data Services | 저장소 | 빠른 생성** 새 저장소 계정 만들기를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-495">Select **New | Data Services | Storage | Quick Create** to start creating a new storage account.</span></span> <span data-ttu-id="5b8ad-496">선택한 계정에 대 한 고유한 이름을 입력 한 **지역** 목록에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-496">Enter a unique name for the account and select a **Region** from the list.</span></span> <span data-ttu-id="5b8ad-497">클릭 **Storage 계정 만들기** 를 계속 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-497">Click **Create Storage Account** to continue.</span></span>

    <span data-ttu-id="5b8ad-498">![새 저장소 계정을 만들](maintainable-azure-websites-managing-change-and-scale/_static/image57.png "새 저장소 계정 만들기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-498">![Creating a new Storage Account](maintainable-azure-websites-managing-change-and-scale/_static/image57.png "Creating a new Storage Account")</span></span>

    <span data-ttu-id="5b8ad-499">*새 저장소 계정 만들기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-499">*Creating a new storage account*</span></span>
3. <span data-ttu-id="5b8ad-500">에 **저장소** 섹션에서 새 저장소 계정의 상태가으로 변경 될 때까지 기다립니다 *Online* 다음 단계를 진행 하기 위해.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-500">In the **Storage** section, wait until the status of the new storage account changes to *Online* in order to continue with the following step.</span></span>

    <span data-ttu-id="5b8ad-501">![만든 저장소 계정](maintainable-azure-websites-managing-change-and-scale/_static/image58.png "만든 저장소 계정")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-501">![Storage Account created](maintainable-azure-websites-managing-change-and-scale/_static/image58.png "Storage Account created")</span></span>

    <span data-ttu-id="5b8ad-502">*만든 저장소 계정*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-502">*Storage Account created*</span></span>
4. <span data-ttu-id="5b8ad-503">저장소 계정 이름을 클릭 한 다음 클릭 합니다 **대시보드** 페이지의 맨 위에 있는 링크입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-503">Click on the storage account name and then click the **Dashboard** link at the top of the page.</span></span> <span data-ttu-id="5b8ad-504">합니다 **대시보드** 페이지 계정과 응용 프로그램 내에서 사용할 수 있는 서비스 끝점의 상태에 대 한 정보를 제공 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-504">The **Dashboard** page provides you with information about the status of the account and the service endpoints that can be used within your applications.</span></span>

    <span data-ttu-id="5b8ad-505">![저장소 계정 대시보드 표시](maintainable-azure-websites-managing-change-and-scale/_static/image59.png "저장소 계정 대시보드를 표시 합니다.")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-505">![Displaying the Storage Account Dashboard](maintainable-azure-websites-managing-change-and-scale/_static/image59.png "Displaying the Storage Account Dashboard")</span></span>

    <span data-ttu-id="5b8ad-506">*저장소 계정 대시보드를 표시합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-506">*Displaying the Storage Account Dashboard*</span></span>
5. <span data-ttu-id="5b8ad-507">클릭 합니다 **액세스 키 관리** 탐색 모음에서 단추입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-507">Click the **Manage Access Keys** button in the navigation bar.</span></span>

    <span data-ttu-id="5b8ad-508">![관리 액세스 키 단추](maintainable-azure-websites-managing-change-and-scale/_static/image60.png "액세스 키 관리 단추")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-508">![Manage Access Keys button](maintainable-azure-websites-managing-change-and-scale/_static/image60.png "Manage Access Keys button")</span></span>

    <span data-ttu-id="5b8ad-509">*관리 액세스 키 단추*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-509">*Manage Access Keys button*</span></span>
6. <span data-ttu-id="5b8ad-510">에 **액세스 키 관리** 대화 상자에서 복사를 **저장소 계정 이름** 및 **기본 액세스 키** 다음 예에서는 해당 필요 하므로 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-510">In the **Manage Access Keys** dialog box, copy the **Storage Account Name** and **Primary Access Key** as you will need them in the following exercise.</span></span> <span data-ttu-id="5b8ad-511">그런 다음 대화 상자를 닫습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-511">Then, close the dialog box.</span></span>

    <span data-ttu-id="5b8ad-512">![관리 액세스 키 대화 상자](maintainable-azure-websites-managing-change-and-scale/_static/image61.png "액세스 키 관리 대화 상자")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-512">![Manage Access Key dialog box](maintainable-azure-websites-managing-change-and-scale/_static/image61.png "Manage Access Key dialog box")</span></span>

    <span data-ttu-id="5b8ad-513">*관리 액세스 키 대화 상자*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-513">*Manage Access Key dialog box*</span></span>

<a id="Ex4Task2"></a>
#### <a name="task-2--uploading-an-asset-to-azure-blob-storage"></a><span data-ttu-id="5b8ad-514">작업 2-Azure Blob Storage에 자산 업로드</span><span class="sxs-lookup"><span data-stu-id="5b8ad-514">Task 2 – Uploading an Asset to Azure Blob Storage</span></span>

<span data-ttu-id="5b8ad-515">이 태스크에서는 저장소 계정에 연결 하려면 Visual Studio에서 서버 탐색기 창을 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-515">In this task, you will use the Server Explorer window from Visual Studio to connect to your storage account.</span></span> <span data-ttu-id="5b8ad-516">다음 blob 컨테이너를 만들고 컨테이너에 도전할 퀴즈 로고를 사용 하 여 파일을 업로드 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-516">You will then create a blob container and upload a file with the Geek Quiz logo to the container.</span></span>

1. <span data-ttu-id="5b8ad-517">사용 하 여 Visual Studio 인스턴스를 전환 합니다 **GeekQuiz** 이전 연습에서 솔루션입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-517">Switch to the Visual Studio instance with the **GeekQuiz** solution from the previous exercise.</span></span>
2. <span data-ttu-id="5b8ad-518">메뉴 모음에서 선택 **뷰** 을 클릭 한 다음 **서버 탐색기**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-518">From the menu bar, select **View** and then click **Server Explorer**.</span></span>
3. <span data-ttu-id="5b8ad-519">**서버 탐색기**, 마우스 오른쪽 단추로 클릭 합니다 **Azure** 노드와 선택 **Azure에 연결 하는 중...** . 구독에 연결 된 Microsoft 계정을 사용 하 여 로그인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-519">In **Server Explorer**, right-click the **Azure** node and select **Connect to Azure...**. Sign in using the Microsoft account associated with your subscription.</span></span>

    ![Windows Azure에 연결](maintainable-azure-websites-managing-change-and-scale/_static/image62.png)

    <span data-ttu-id="5b8ad-521">*Azure에 연결*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-521">*Connect to Azure*</span></span>
4. <span data-ttu-id="5b8ad-522">확장 된 **Azure** 노드를 마우스 오른쪽 단추로 클릭 **저장소** 선택한 **외부 저장소 연결 하는 중...** .</span><span class="sxs-lookup"><span data-stu-id="5b8ad-522">Expand the **Azure** node, right-click **Storage** and select **Attach External Storage...**.</span></span>
5. <span data-ttu-id="5b8ad-523">에 **새 저장소 계정 추가** 대화 상자에 입력를 **계정 이름** 및 **계정 키** 고 이전 작업에서 가져온 **확인**.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-523">In the **Add New Storage Account** dialog box, enter the **Account name** and **Account key** you obtained in the previous task and click **OK**.</span></span>

    ![새 저장소 계정 대화 상자를 추가 합니다.](maintainable-azure-websites-managing-change-and-scale/_static/image63.png)

    <span data-ttu-id="5b8ad-525">*새 저장소 계정 대화 상자를 추가 합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-525">*Add New Storage Account dialog box*</span></span>
6. <span data-ttu-id="5b8ad-526">저장소 계정 아래에 표시 해야 합니다 **저장소** 노드.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-526">Your storage account should appear under the **Storage** node.</span></span> <span data-ttu-id="5b8ad-527">저장소 계정을 확장 하 고 마우스 오른쪽 단추로 클릭 **Blob** 선택한 **Blob 컨테이너 만들기...** .</span><span class="sxs-lookup"><span data-stu-id="5b8ad-527">Expand your storage account, right-click **Blobs** and select **Create Blob Container...**.</span></span>

    <span data-ttu-id="5b8ad-528">![Blob 컨테이너 만들기](maintainable-azure-websites-managing-change-and-scale/_static/image64.png "Blob 컨테이너 만들기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-528">![Create Blob Container](maintainable-azure-websites-managing-change-and-scale/_static/image64.png "Create Blob Container")</span></span>

    <span data-ttu-id="5b8ad-529">*Blob 컨테이너 만들기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-529">*Create Blob Container*</span></span>
7. <span data-ttu-id="5b8ad-530">에 **Blob 컨테이너 만들기** 대화 상자, blob 컨테이너에 대 한 이름을 입력 하 고 클릭 **확인**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-530">In the **Create Blob Container** dialog box, enter a name for the blob container and click **OK**.</span></span>

    <span data-ttu-id="5b8ad-531">![Create Blob Container 대화 상자](maintainable-azure-websites-managing-change-and-scale/_static/image65.png "Blob 컨테이너 만들기 대화 상자")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-531">![Create Blob Container dialog box](maintainable-azure-websites-managing-change-and-scale/_static/image65.png "Create Blob Container dialog box")</span></span>

    <span data-ttu-id="5b8ad-532">*Blob 컨테이너 만들기 대화 상자*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-532">*Create Blob Container dialog box*</span></span>
8. <span data-ttu-id="5b8ad-533">새 blob 컨테이너에 추가 해야 합니다 **Blob** 노드.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-533">The new blob container should be added to the **Blobs** node.</span></span> <span data-ttu-id="5b8ad-534">컨테이너가 공개 되도록 컨테이너에 액세스 권한을 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-534">Change the access permissions in the container to make the container public.</span></span> <span data-ttu-id="5b8ad-535">이렇게 하려면 마우스 오른쪽 단추로 클릭 합니다 **이미지** 선택한 컨테이너 **속성**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-535">To do this, right-click the **images** container and select **Properties**.</span></span>

    <span data-ttu-id="5b8ad-536">![컨테이너 속성을 이미지](maintainable-azure-websites-managing-change-and-scale/_static/image66.png "컨테이너 속성 이미지")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-536">![images container properties](maintainable-azure-websites-managing-change-and-scale/_static/image66.png "images container properties")</span></span>

    <span data-ttu-id="5b8ad-537">*이미지 컨테이너 속성*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-537">*Images container properties*</span></span>
9. <span data-ttu-id="5b8ad-538">에 **속성** 창에서 **공용 읽기 액세스** 에 **컨테이너**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-538">In the **Properties** window, set the **Public Read Access** to **Container**.</span></span>

    <span data-ttu-id="5b8ad-539">![공용 읽기 액세스 속성을 변경](maintainable-azure-websites-managing-change-and-scale/_static/image67.png "공용 읽기 액세스 속성 변경")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-539">![Changing public read access property](maintainable-azure-websites-managing-change-and-scale/_static/image67.png "Changing public read access property")</span></span>

    <span data-ttu-id="5b8ad-540">*공용 읽기 액세스 속성 변경*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-540">*Changing public read access property*</span></span>
10. <span data-ttu-id="5b8ad-541">공용 액세스 속성을 변경 하려는 경우 메시지가 표시 되 면 **예**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-541">When prompted if you are sure you want to change the public access property, click **Yes**.</span></span>

    <span data-ttu-id="5b8ad-542">![Microsoft Visual Studio 경고](maintainable-azure-websites-managing-change-and-scale/_static/image68.png "Microsoft Visual Studio 경고")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-542">![Microsoft Visual Studio warning](maintainable-azure-websites-managing-change-and-scale/_static/image68.png "Microsoft Visual Studio warning")</span></span>

    <span data-ttu-id="5b8ad-543">*Microsoft Visual Studio 경고*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-543">*Microsoft Visual Studio warning*</span></span>
11. <span data-ttu-id="5b8ad-544">**서버 탐색기**를 마우스 오른쪽 단추로 클릭 합니다 **이미지** blob 컨테이너 및 선택 **Blob 컨테이너 보기**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-544">In **Server Explorer**, right-click in the **images** blob container and select **View Blob Container**.</span></span>

    <span data-ttu-id="5b8ad-545">![Blob 컨테이너를 볼](maintainable-azure-websites-managing-change-and-scale/_static/image69.png "Blob 컨테이너 보기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-545">![View Blob Container](maintainable-azure-websites-managing-change-and-scale/_static/image69.png "View Blob Container")</span></span>

    <span data-ttu-id="5b8ad-546">*Blob 컨테이너 보기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-546">*View Blob Container*</span></span>
12. <span data-ttu-id="5b8ad-547">이미지 컨테이너 새 창에서 열고는 항목이 없으면 범례가 표시 되도록 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-547">The images container should open in a new window and a legend with no entries should be shown.</span></span> <span data-ttu-id="5b8ad-548">클릭 합니다 **업로드** 아이콘 파일을 blob 컨테이너에 업로드 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-548">Click the **upload** icon to upload a file to the blob container.</span></span>

    <span data-ttu-id="5b8ad-549">![항목이 없는 이미지 컨테이너가](maintainable-azure-websites-managing-change-and-scale/_static/image70.png "항목이 없는 이미지 컨테이너")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-549">![Images container with no entries](maintainable-azure-websites-managing-change-and-scale/_static/image70.png "Images container with no entries")</span></span>

    <span data-ttu-id="5b8ad-550">*항목이 없는 이미지 컨테이너*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-550">*Images container with no entries*</span></span>
13. <span data-ttu-id="5b8ad-551">에 **Blob 업로드** 대화 상자에서 **자산** 랩의 폴더입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-551">In the **Upload Blob** dialog box, navigate to the **Assets** folder of the lab.</span></span> <span data-ttu-id="5b8ad-552">선택 된 **로고 big.png** 파일을 클릭 **오픈**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-552">Select the **logo-big.png** file and click **Open**.</span></span>
14. <span data-ttu-id="5b8ad-553">파일을 업로드할 때까지 기다립니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-553">Wait until the file is uploaded.</span></span> <span data-ttu-id="5b8ad-554">업로드가 완료 되 면 이미지 컨테이너에 파일을 나열 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-554">When the upload completes, the file should be listed in the images container.</span></span> <span data-ttu-id="5b8ad-555">파일 항목을 마우스 오른쪽 단추로 누르고 **URL 복사**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-555">Right-click the file entry and select **Copy URL**.</span></span>

    <span data-ttu-id="5b8ad-556">![Blob URL을 복사](maintainable-azure-websites-managing-change-and-scale/_static/image71.png "blob 파일 URL 복사")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-556">![Copy blob URL](maintainable-azure-websites-managing-change-and-scale/_static/image71.png "Copy blob file URL")</span></span>

    <span data-ttu-id="5b8ad-557">*Blob URL 복사*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-557">*Copy blob URL*</span></span>
15. <span data-ttu-id="5b8ad-558">Internet Explorer를 열고 URL을 붙여 넣습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-558">Open Internet Explorer and paste the URL.</span></span> <span data-ttu-id="5b8ad-559">다음 이미지는 브라우저에 표시 되어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-559">The following image should be shown in the browser.</span></span>

    <span data-ttu-id="5b8ad-560">![Windows Blob Storage에서 이미지 로고 big.png](maintainable-azure-websites-managing-change-and-scale/_static/image72.png "저장소에서 big.png 로고 이미지")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-560">![logo-big.png image from Windows Blob Storage](maintainable-azure-websites-managing-change-and-scale/_static/image72.png "logo-big.png image from storage")</span></span>

    <span data-ttu-id="5b8ad-561">*Azure Blob Storage에서 big.png 로고 이미지*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-561">*logo-big.png image from Azure Blob Storage*</span></span>

<a id="Ex4Task3"></a>
#### <a name="task-3--updating-the-solution-to-consume-static-content-from-azure-blob-storage"></a><span data-ttu-id="5b8ad-562">작업 3 – Azure Blob Storage에서 정적 콘텐츠를 사용 하는 솔루션 업데이트</span><span class="sxs-lookup"><span data-stu-id="5b8ad-562">Task 3 – Updating the Solution to Consume Static Content from Azure Blob Storage</span></span>

<span data-ttu-id="5b8ad-563">이 태스크에서는 구성 된 **GeekQuiz** 이미지를 사용 하는 솔루션 Azure Blob Storage에 업로드 (대신 웹 앱에 있는 이미지)에서 ASP.NET URL 다시 쓰기 규칙을 추가 하 여는 **web.config**파일입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-563">In this task, you will configure the **GeekQuiz** solution to consume the image uploaded to Azure Blob Storage (instead of the image located in the web app) by adding an ASP.NET URL rewrite rule in the **web.config** file.</span></span>

1. <span data-ttu-id="5b8ad-564">Visual Studio에서 엽니다는 **Web.config** 파일을 **GeekQuiz** 찾아서 프로젝트를 **&lt;system.webServer&gt;** 요소.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-564">In Visual Studio, open the **Web.config** file inside the **GeekQuiz** project and locate the **&lt;system.webServer&gt;** element.</span></span>
2. <span data-ttu-id="5b8ad-565">저장소 계정 이름을 사용 하 여 자리 표시자를 업데이트는 URL 재작성 규칙을 추가 하려면 다음 코드를 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-565">Add the following code to add an URL rewrite rule, updating the placeholder with your storage account name.</span></span>

    <span data-ttu-id="5b8ad-566">(코드 조각- *WebSitesInProduction-Ex4-UrlRewriteRule*)</span><span class="sxs-lookup"><span data-stu-id="5b8ad-566">(Code Snippet - *WebSitesInProduction - Ex4 - UrlRewriteRule*)</span></span>

    [!code-xml[Main](maintainable-azure-websites-managing-change-and-scale/samples/sample17.xml)]

    > [!NOTE]
    > <span data-ttu-id="5b8ad-567">URL 재작성은 들어오는 웹 요청을 가로채 고 다른 리소스에 요청을 리디렉션하는 프로세스입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-567">URL rewriting is the process of intercepting an incoming Web request and redirecting the request to a different resource.</span></span> <span data-ttu-id="5b8ad-568">URL 재작성 규칙에 요청을 필요로 하는 경우가 이러한 리디렉션되는 재작성 엔진을 알려 줍니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-568">The URL rewriting rules tells the rewriting engine when a request needs to be redirected, and where should they be redirected.</span></span> <span data-ttu-id="5b8ad-569">재작성 규칙을 두 개의 문자열로 구성 되기: 요청한 URL에서 찾을 패턴 (일반적으로 사용 하 여 정규식)을 하는 경우를 사용 하 여 패턴을 바꿀 문자열을 찾을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-569">A rewriting rule is composed of two strings: the pattern to look for in the requested URL (usually, using regular expressions), and the string to replace the pattern with, if found.</span></span> <span data-ttu-id="5b8ad-570">자세한 내용은 [ASP.NET의 URL 재작성](https://msdn.microsoft.com/library/ms972974.aspx)합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-570">For more information, see [URL Rewriting in ASP.NET](https://msdn.microsoft.com/library/ms972974.aspx).</span></span>
3. <span data-ttu-id="5b8ad-571">키를 눌러 **CTRL + S** 변경 내용을 저장 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-571">Press **CTRL + S** to save the changes.</span></span>
4. <span data-ttu-id="5b8ad-572">새 **Git Bash** Azure App Service에 대 한 업데이트 된 응용 프로그램을 배포 하는 콘솔입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-572">Open a new **Git Bash** console to deploy the updated application to Azure App Service.</span></span>
5. <span data-ttu-id="5b8ad-573">Azure에 변경 내용을 적용 하려면 다음 명령을 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-573">Execute the following commands to push the changes to Azure.</span></span> <span data-ttu-id="5b8ad-574">업데이트를 *[YOUR 응용 프로그램 경로]* 에 대 한 경로 사용 하 여 자리 표시자를 **GeekQuiz** 솔루션입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-574">Update the *[YOUR-APPLICATION-PATH]* placeholder with the path to the **GeekQuiz** solution.</span></span> <span data-ttu-id="5b8ad-575">배포 암호에 대 한 라는 메시지가 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-575">You will be prompted for your deployment password.</span></span>

    [!code-console[Main](maintainable-azure-websites-managing-change-and-scale/samples/sample18.cmd)]

    ![Azure에 배포 업데이트](maintainable-azure-websites-managing-change-and-scale/_static/image73.png)

    <span data-ttu-id="5b8ad-577">*Azure에 배포 업데이트*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-577">*Deploying update to Azure*</span></span>

<a id="Ex4Task4"></a>
#### <a name="task-4--verification"></a><span data-ttu-id="5b8ad-578">작업 4-확인</span><span class="sxs-lookup"><span data-stu-id="5b8ad-578">Task 4 – Verification</span></span>

<span data-ttu-id="5b8ad-579">이 작업에서는 사용 하 여 **Internet Explorer** 이동할 합니다 **매니아 퀴즈** 응용 프로그램 및 확인을 URL 재작성 규칙 이미지 작동 하는 사용자가 리디렉션됩니다에서 호스팅되는 이미지가 **Azure Blob 저장소**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-579">In this task you will use **Internet Explorer** to browse the **Geek Quiz** application and check that the URL rewrite rule for images works and you are redirected to the image hosted on **Azure Blob Storage**.</span></span>

1. <span data-ttu-id="5b8ad-580">Internet Explorer를 열고 웹 앱으로 이동 (예: `http://<your-web-site>.azurewebsites.net`).</span><span class="sxs-lookup"><span data-stu-id="5b8ad-580">Open Internet Explorer and navigate to your web app (e.g. `http://<your-web-site>.azurewebsites.net`).</span></span> <span data-ttu-id="5b8ad-581">이전에 만든된 자격 증명을 사용 하 여 로그인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-581">Log in using the previously created credentials.</span></span>

    <span data-ttu-id="5b8ad-582">![이미지를 사용 하 여 Geek 퀴즈 웹 앱을 보여 주는](maintainable-azure-websites-managing-change-and-scale/_static/image74.png "이미지로 Geek 퀴즈 웹 앱을 표시")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-582">![Showing the Geek Quiz web app with the image](maintainable-azure-websites-managing-change-and-scale/_static/image74.png "Showing the Geek Quiz web app with the image")</span></span>

    <span data-ttu-id="5b8ad-583">*이미지를 사용 하 여 Geek 퀴즈 웹 앱을 표시*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-583">*Showing the Geek Quiz web app with the image*</span></span>
2. <span data-ttu-id="5b8ad-584">키를 눌러 **F12** 개발 도구를 시작 하려면 선택 합니다 **네트워크** 탭 및 기록을 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-584">Press **F12** to launch the development tools, select the **Network** tab and start recording.</span></span>

    <span data-ttu-id="5b8ad-585">![네트워크 기록 시작](maintainable-azure-websites-managing-change-and-scale/_static/image75.png "네트워크 녹음/녹화 시작")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-585">![Starting network recording](maintainable-azure-websites-managing-change-and-scale/_static/image75.png "Starting network recording")</span></span>

    <span data-ttu-id="5b8ad-586">*네트워크 녹음/녹화 시작*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-586">*Starting network recording*</span></span>
3. <span data-ttu-id="5b8ad-587">키를 눌러 **ctrl+f5** 웹 페이지를 새로 고쳐야 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-587">Press **CTRL + F5** to refresh the web page.</span></span>
4. <span data-ttu-id="5b8ad-588">HTTP 요청에 대 한 페이지 로드가 완료 되 면 표시 합니다 **/img/logo-big.png** HTTP 사용 하 여 URL **301** (리디렉션) 결과 및 다른 요청을 `http://[YOUR-STORAGE-ACCOUNT].blob.core.windows.net/images/logo-big.png` HTTP사용하여URL**200** 결과입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-588">Once the page has finished loading, you should see an HTTP request for the **/img/logo-big.png** URL with an HTTP **301** result (redirect) and another request for `http://[YOUR-STORAGE-ACCOUNT].blob.core.windows.net/images/logo-big.png` URL with a HTTP **200** result.</span></span>

    <span data-ttu-id="5b8ad-589">![확인 URL 리디렉션](maintainable-azure-websites-managing-change-and-scale/_static/image76.png "리디렉션 개발 도구에 표시")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-589">![Verifying the URL redirect](maintainable-azure-websites-managing-change-and-scale/_static/image76.png "Showing the redirect in Dev Tools")</span></span>

    <span data-ttu-id="5b8ad-590">*URL 리디렉션 확인*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-590">*Verifying the URL redirect*</span></span>

<a id="Exercise5"></a>
### <a name="exercise-5-using-autoscale-for-web-apps"></a><span data-ttu-id="5b8ad-591">실습 5: 웹 앱에 대 한 자동 크기 조정 사용</span><span class="sxs-lookup"><span data-stu-id="5b8ad-591">Exercise 5: Using Autoscale for Web Apps</span></span>

> [!NOTE]
> <span data-ttu-id="5b8ad-592">웹 부하에 대 한 지원이 필요 하므로이 실습은 선택 사항 &amp; 에서만 사용할 수 있는 성능 테스트 **Visual Studio 2013 Ultimate Edition**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-592">This exercise is optional, since it requires support for Web Load &amp; Performance Testing which is only available for **Visual Studio 2013 Ultimate Edition**.</span></span> <span data-ttu-id="5b8ad-593">Visual Studio 2013의 특정 기능에 대 한 자세한 내용은 버전 비교 [여기](https://www.microsoft.com/visualstudio/eng/products/compare)합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-593">For more information on specific Visual Studio 2013 features, compare versions [here](https://www.microsoft.com/visualstudio/eng/products/compare).</span></span>


<span data-ttu-id="5b8ad-594">**Azure App Service Web Apps** 에서 실행 중인 웹 앱에 대 한 자동 크기 조정 기능을 제공 **표준 모드**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-594">**Azure App Service Web Apps** provides the Autoscale feature for web apps running in **Standard Mode**.</span></span> <span data-ttu-id="5b8ad-595">자동 크기 조정에 Azure를 부하에 따라 웹 앱의 인스턴스 수를 자동으로 확장할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-595">Autoscale lets Azure automatically scale the instance count of your web app depending on the load.</span></span> <span data-ttu-id="5b8ad-596">자동 크기 조정 설정 되 면 Azure 웹 앱의 CPU가 5 분 마다 한 번 확인 하 고 해당 시점에 필요한 만큼 인스턴스가 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-596">When Autoscale is enabled, Azure checks the CPU of your web app once every five minutes and adds instances as needed at that point in time.</span></span> <span data-ttu-id="5b8ad-597">CPU 사용량이 낮은 경우 인스턴스가 제거 됩니다 두 시간 마다 한 번씩 웹 앱의 성능을 성능이 저하 되었음을 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-597">If the CPU usage is low, Azure will remove instances once every two hours to ensure that the performance of your web app is not degraded.</span></span>

<span data-ttu-id="5b8ad-598">이 연습에서 구성 하는 데 필요한 단계를 통해 이동 합니다 **자동 크기 조정** 에 대 한 기능을 **Geek 퀴즈** 웹 앱입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-598">In this exercise you will go through the steps required to configure the **Autoscale** feature for the **Geek Quiz** web app.</span></span> <span data-ttu-id="5b8ad-599">인스턴스를 업그레이드 하는 트리거를 응용 프로그램에서 충분 한 CPU 부하를 생성 하는 Visual Studio 부하 테스트를 실행 하 여이 기능을 확인 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-599">You will verify this feature by running a Visual Studio load test to generate enough CPU load on the application to trigger an instance upgrade.</span></span>

<a id="Ex5Task1"></a>
#### <a name="task-1--configuring-autoscale-based-on-the-cpu-metric"></a><span data-ttu-id="5b8ad-600">작업 1-CPU 메트릭을 기반으로 구성 자동 크기 조정</span><span class="sxs-lookup"><span data-stu-id="5b8ad-600">Task 1 – Configuring Autoscale Based on the CPU Metric</span></span>

<span data-ttu-id="5b8ad-601">이 태스크에서는 연습 2에서 만든 웹 앱에 대 한 자동 크기 조정 기능을 사용 하려면 Azure 관리 포털을 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-601">In this task you will use the Azure management portal to enable the Autoscale feature for the web app you created in Exercise 2.</span></span>

1. <span data-ttu-id="5b8ad-602">에 [Azure 관리 포털](https://manage.windowsazure.com/)를 선택 **웹 사이트** 연습 2에서 만든 웹 앱을 클릭 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-602">In the [Azure management portal](https://manage.windowsazure.com/), select **Websites** and click the web app you created in Exercise 2.</span></span>
2. <span data-ttu-id="5b8ad-603">로 이동 합니다 **확장** 페이지입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-603">Navigate to the **Scale** page.</span></span> <span data-ttu-id="5b8ad-604">아래는 **용량** 섹션에서 **CPU** 에 대 한 합니다 **메트릭 별 크기 조정** 구성 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-604">Under the **capacity** section, select **CPU** for the **Scale by Metric** configuration.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-605">CPU 별 크기 조정 하는 경우 Azure CPU 사용량을 변경 하는 경우 앱을 사용 하는 인스턴스 수를 동적으로 조정 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-605">When scaling by CPU, Azure dynamically adjusts the number of instances that the app uses if the CPU usage changes.</span></span>

    <span data-ttu-id="5b8ad-606">![CPU 별 크기 조정 하도록 선택 하면](maintainable-azure-websites-managing-change-and-scale/_static/image77.png "자동 크기 조정에 대 한 CPU 메트릭 선택")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-606">![Selecting to scale by CPU](maintainable-azure-websites-managing-change-and-scale/_static/image77.png "Selecting the CPU metric for auto scaling")</span></span>

    <span data-ttu-id="5b8ad-607">*CPU 별 크기 조정 하도록 선택*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-607">*Selecting to scale by CPU*</span></span>
3. <span data-ttu-id="5b8ad-608">변경 된 **대상 CPU** 구성을 **20**-**40** 백분율입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-608">Change the **Target CPU** configuration to **20**-**40** percent.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-609">이 범위는 웹 앱에 대 한 평균 CPU 사용량을 나타냅니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-609">This range represents the average CPU usage for your web app.</span></span> <span data-ttu-id="5b8ad-610">Azure을 추가 하거나이 범위에서 웹 앱을 유지 하도록 인스턴스를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-610">Azure will add or remove instances to keep your web app in this range.</span></span> <span data-ttu-id="5b8ad-611">에 지정 된 크기 조정 시 사용 되는 인스턴스의 최소 및 최대 수를 **인스턴스 수** 구성 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-611">The minimum and maximum number of instances used for scaling is specified in the **Instance Count** configuration.</span></span> <span data-ttu-id="5b8ad-612">Azure 위나 제한을 벗어나서 이동 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-612">Azure will never go above or beyond that limit.</span></span>
    > 
    > <span data-ttu-id="5b8ad-613">기본값 **대상 CPU** 값은이 랩의 목적에 대해서만 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-613">The default **Target CPU** values are modified just for the purposes of this lab.</span></span> <span data-ttu-id="5b8ad-614">작은 값을 사용 하 여 CPU 범위를 구성 하 여 보통 수준의 부하는 응용 프로그램에 배치 되 면 자동 크기 조정 트리거와 가능성은 증가 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-614">By configuring the CPU range with small values, you are increasing the chances to trigger Autoscale when a moderate load is placed on the application.</span></span>

    <span data-ttu-id="5b8ad-615">![변경 대상 CPU 20%에서 40% 사이 여야](maintainable-azure-websites-managing-change-and-scale/_static/image78.png "20%에서 40% 사이 여야 CPU 대상 변경")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-615">![Changing the target CPU to be between 20 and 40 percent](maintainable-azure-websites-managing-change-and-scale/_static/image78.png "Changing the target CPU to be between 20 and 40 percent")</span></span>

    <span data-ttu-id="5b8ad-616">*변경 대상 CPU 20%에서 40% 사이 여야*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-616">*Changing the Target CPU to be between 20 and 40 percent*</span></span>
4. <span data-ttu-id="5b8ad-617">클릭 **저장할** 변경 내용을 저장 하려면 명령 모음에서 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-617">Click **Save** in the command bar to save the changes.</span></span>

<a id="Ex5Task2"></a>
#### <a name="task-2--load-testing-with-visual-studio"></a><span data-ttu-id="5b8ad-618">작업 2-부하 테스트를 Visual Studio를 사용 하 여</span><span class="sxs-lookup"><span data-stu-id="5b8ad-618">Task 2 – Load Testing with Visual Studio</span></span>

<span data-ttu-id="5b8ad-619">이제 **자동 크기 조정** 되었습니다 구성 만듭니다는 **웹 성능 및 부하 테스트 프로젝트** 웹 앱에서 일부 CPU 부하를 생성 하는 Visual Studio에서.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-619">Now that **Autoscale** has been configured, you will create a **Web Performance and Load Test Project** in Visual Studio to generate some CPU load on your web app.</span></span>

1. <span data-ttu-id="5b8ad-620">오픈 **Visual Studio Ultimate 2013** 선택한 **파일 | 새 | 프로젝트...**  새 솔루션을 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-620">Open **Visual Studio Ultimate 2013** and select **File | New | Project...** to start a new solution.</span></span>

    <span data-ttu-id="5b8ad-621">![새 프로젝트를 만드는](maintainable-azure-websites-managing-change-and-scale/_static/image79.png "새 프로젝트 만들기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-621">![Creating a new project](maintainable-azure-websites-managing-change-and-scale/_static/image79.png "Creating a new project")</span></span>

    <span data-ttu-id="5b8ad-622">*새 프로젝트 만들기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-622">*Creating a new project*</span></span>
2. <span data-ttu-id="5b8ad-623">에 **새 프로젝트** 대화 상자에서 **웹 성능 및 부하 테스트 프로젝트** 아래에서 **Visual C# | 테스트** 탭 합니다. 했는지 **.NET Framework 4.5** 는 프로젝트의 이름을 선택 *WebAndLoadTestProject*, 선택는 **위치** 클릭 **확인**.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-623">In the **New Project** dialog box, select **Web Performance and Load Test Project** under the **Visual C# | Test** tab. Make sure **.NET Framework 4.5** is selected, name the project *WebAndLoadTestProject*, choose a **Location** and click **OK**.</span></span>

    <span data-ttu-id="5b8ad-624">![새 웹 및 부하 테스트 프로젝트를 만드는](maintainable-azure-websites-managing-change-and-scale/_static/image80.png "새 웹 및 부하 테스트 프로젝트 만들기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-624">![Creating a new Web and Load Test project](maintainable-azure-websites-managing-change-and-scale/_static/image80.png "Creating a new Web and Load Test project")</span></span>

    <span data-ttu-id="5b8ad-625">*새 웹 및 부하 테스트 프로젝트 만들기*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-625">*Creating a new Web and Load Test project*</span></span>
3. <span data-ttu-id="5b8ad-626">에 **WebTest1.webtest** 마우스 오른쪽 단추로 클릭 합니다 **WebTest1** 노드와 클릭 **요청 추가**.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-626">In the **WebTest1.webtest** Right-click the **WebTest1** node and click **Add Request**.</span></span>

    <span data-ttu-id="5b8ad-627">![요청 WebTest1 추가할](maintainable-azure-websites-managing-change-and-scale/_static/image81.png "WebTest1 요청 추가")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-627">![Adding a request to WebTest1](maintainable-azure-websites-managing-change-and-scale/_static/image81.png "Adding a request to WebTest1")</span></span>

    <span data-ttu-id="5b8ad-628">*WebTest1 요청 추가*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-628">*Adding a request to WebTest1*</span></span>
4. <span data-ttu-id="5b8ad-629">에 **속성** 창 새 요청 노드의 업데이트는 **Url** 웹 앱의 URL을 가리키도록 속성 (예: *[ http://geek-quiz.azurewebsites.net/ ](http://geek-quiz.azurewebsites.net/)*).</span><span class="sxs-lookup"><span data-stu-id="5b8ad-629">In the **Properties** window of the new request node, update the **Url** property to point to the URL of your web app (e.g. *[http://geek-quiz.azurewebsites.net/](http://geek-quiz.azurewebsites.net/)*).</span></span>

    <span data-ttu-id="5b8ad-630">![Url 속성을 변경](maintainable-azure-websites-managing-change-and-scale/_static/image82.png "Url 속성 변경")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-630">![Changing the Url property](maintainable-azure-websites-managing-change-and-scale/_static/image82.png "Changing the Url property")</span></span>

    <span data-ttu-id="5b8ad-631">*Url 속성 변경*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-631">*Changing the Url property*</span></span>
5. <span data-ttu-id="5b8ad-632">에 **WebTest1.webtest** 창에서 마우스 오른쪽 단추로 클릭 **WebTest1** 클릭 하 고 **루프 추가...** .</span><span class="sxs-lookup"><span data-stu-id="5b8ad-632">In the **WebTest1.webtest** window, right-click **WebTest1** and click **Add Loop...**.</span></span>

    <span data-ttu-id="5b8ad-633">![WebTest1에 루프 추가](maintainable-azure-websites-managing-change-and-scale/_static/image83.png "WebTest1에 루프 추가")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-633">![Adding a loop to WebTest1](maintainable-azure-websites-managing-change-and-scale/_static/image83.png "Adding a loop to WebTest1")</span></span>

    <span data-ttu-id="5b8ad-634">*WebTest1에 루프 추가*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-634">*Adding a loop to WebTest1*</span></span>
6. <span data-ttu-id="5b8ad-635">에 **루프에 조건부 규칙 추가 및 항목** 대화 상자에서를 **For 루프** 규칙 및 다음 속성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-635">In the **Add Conditional Rule and Items to Loop** dialog box, select the **For Loop** rule and modify the following properties.</span></span>

   1. <span data-ttu-id="5b8ad-636">**종료 값:** 1000</span><span class="sxs-lookup"><span data-stu-id="5b8ad-636">**Terminating value:** 1000</span></span>
   2. <span data-ttu-id="5b8ad-637">**컨텍스트 매개 변수 이름:** 반복기</span><span class="sxs-lookup"><span data-stu-id="5b8ad-637">**Context Parameter Name:** Iterator</span></span>
   3. <span data-ttu-id="5b8ad-638">**증가값:** 1</span><span class="sxs-lookup"><span data-stu-id="5b8ad-638">**Increment Value:** 1</span></span>

      <span data-ttu-id="5b8ad-639">![루프에 대 한 규칙을 선택 하 고 속성을 업데이트](maintainable-azure-websites-managing-change-and-scale/_static/image84.png "루프에 대 한 규칙을 선택 하 고 속성 업데이트")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-639">![Selecting the For Loop rule and updating the properties](maintainable-azure-websites-managing-change-and-scale/_static/image84.png "Selecting the For Loop rule and updating the properties")</span></span>

      <span data-ttu-id="5b8ad-640">*루프에 대 한 규칙을 선택 하 고 속성 업데이트*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-640">*Selecting the For Loop rule and updating the properties*</span></span>
7. <span data-ttu-id="5b8ad-641">아래는 **루프의 항목** 섹션 루프에 대 한 첫 번째 및 마지막 항목이 이전에 만든 요청을 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-641">Under the **Items in loop** section, select the request you created previously to be the first and last item for the loop.</span></span> <span data-ttu-id="5b8ad-642">계속하려면 **확인** 을 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-642">Click **OK** to continue.</span></span>

    <span data-ttu-id="5b8ad-643">![루프에 대 한 첫 번째 및 마지막 항목 선택](maintainable-azure-websites-managing-change-and-scale/_static/image85.png "루프에 대 한 첫 번째 및 마지막 항목 선택")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-643">![Selecting the first and last items for the loop](maintainable-azure-websites-managing-change-and-scale/_static/image85.png "Selecting the first and last items for the loop")</span></span>

    <span data-ttu-id="5b8ad-644">*루프에 대 한 첫 번째 및 마지막 항목 선택*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-644">*Selecting the first and last items for the loop*</span></span>
8. <span data-ttu-id="5b8ad-645">**솔루션 탐색기**를 마우스 오른쪽 단추로 클릭 합니다 **WebAndLoadTestProject** 프로젝트를 확장 하 고는 **추가** 메뉴를 선택 **부하 테스트...** .</span><span class="sxs-lookup"><span data-stu-id="5b8ad-645">In **Solution Explorer**, right-click the **WebAndLoadTestProject** project, expand the **Add** menu and select **Load Test...**.</span></span>

    <span data-ttu-id="5b8ad-646">![부하 테스트 프로젝트에 추가 WebAndLoadTestProject](maintainable-azure-websites-managing-change-and-scale/_static/image86.png "WebAndLoadTestProject 프로젝트에 부하 테스트 추가")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-646">![Adding a Load Test to the WebAndLoadTestProject project](maintainable-azure-websites-managing-change-and-scale/_static/image86.png "Adding a Load Test to the WebAndLoadTestProject project")</span></span>

    <span data-ttu-id="5b8ad-647">*부하 테스트 프로젝트에 추가 WebAndLoadTestProject*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-647">*Adding a Load Test to the WebAndLoadTestProject project*</span></span>
9. <span data-ttu-id="5b8ad-648">에 **부하 테스트 새로 만들기 마법사** 대화 상자, 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-648">In the **New Load Test Wizard** dialog box, click **Next**.</span></span>

    <span data-ttu-id="5b8ad-649">![부하 테스트 새로 만들기 마법사](maintainable-azure-websites-managing-change-and-scale/_static/image87.png "부하 테스트 새로 만들기 마법사")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-649">![New Load Test Wizard](maintainable-azure-websites-managing-change-and-scale/_static/image87.png "New Load Test Wizard")</span></span>

    <span data-ttu-id="5b8ad-650">*부하 테스트 새로 만들기 마법사*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-650">*New Load Test Wizard*</span></span>
10. <span data-ttu-id="5b8ad-651">에 **시나리오** 페이지에서 **인지 시간을 사용 하지 마십시오** 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-651">In the **Scenario** page, select **Do not use think times** and click **Next**.</span></span>

    <span data-ttu-id="5b8ad-652">![선택 하면 대기 시간을 사용할 수 없습니다](maintainable-azure-websites-managing-change-and-scale/_static/image88.png "를 인지 시간을 사용 하지 않도록 선택 하면")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-652">![Selecting not to use think times](maintainable-azure-websites-managing-change-and-scale/_static/image88.png "Selecting not to use think times")</span></span>

    <span data-ttu-id="5b8ad-653">*인지 시간을 사용 하 여 선택 하지 않음*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-653">*Selecting not to use think times*</span></span>
11. <span data-ttu-id="5b8ad-654">에 **부하 패턴** 페이지에서 확인 합니다 **일정 부하** 옵션을 선택 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-654">In the **Load Pattern** page, make sure that the **Constant Load** option is selected.</span></span> <span data-ttu-id="5b8ad-655">변경 합니다 **사용자 수** 설정을 **250** 사용자 및 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-655">Change the **User Count** setting to **250** users and click **Next**.</span></span>

    <span data-ttu-id="5b8ad-656">![사용자 수가 250으로 변경](maintainable-azure-websites-managing-change-and-scale/_static/image89.png "250 사용자 수를 변경 합니다.")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-656">![Changing the user count to 250](maintainable-azure-websites-managing-change-and-scale/_static/image89.png "Changing the user count to 250")</span></span>

    <span data-ttu-id="5b8ad-657">*사용자 수가 250으로 변경*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-657">*Changing the user count to 250*</span></span>
12. <span data-ttu-id="5b8ad-658">에 **테스트 조합 모델** 페이지에서 **순차적 테스트 순서 기반** 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-658">In the **Test Mix Model** page, select **Based on sequential test order** and click **Next**.</span></span>

    <span data-ttu-id="5b8ad-659">![테스트 조합 모델 선택](maintainable-azure-websites-managing-change-and-scale/_static/image90.png "테스트 조합 모델 선택")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-659">![Selecting the test mix model](maintainable-azure-websites-managing-change-and-scale/_static/image90.png "Selecting the test mix model")</span></span>

    <span data-ttu-id="5b8ad-660">*테스트 조합 모델 선택*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-660">*Selecting the test mix model*</span></span>
13. <span data-ttu-id="5b8ad-661">에 **테스트 조합 모델** 페이지에서 **추가...**  조합에 테스트를 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-661">In the **Test Mix Model** page, click **Add...** to add a test to the mix.</span></span>

    <span data-ttu-id="5b8ad-662">![테스트 조합에 테스트 추가](maintainable-azure-websites-managing-change-and-scale/_static/image91.png "테스트 조합에 테스트 추가")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-662">![Adding a test to the test mix](maintainable-azure-websites-managing-change-and-scale/_static/image91.png "Adding a test to the test mix")</span></span>

    <span data-ttu-id="5b8ad-663">*테스트 조합에 테스트 추가*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-663">*Adding a test to the test mix*</span></span>
14. <span data-ttu-id="5b8ad-664">에 **테스트 추가** 대화 상자에서 두 번 클릭 **WebTest1** 테스트를 추가 합니다 **선택한 테스트** 목록입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-664">In the **Add Tests** dialog box, double-click **WebTest1** to add the test to the **Selected tests** list.</span></span> <span data-ttu-id="5b8ad-665">계속하려면 **확인** 을 클릭합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-665">Click **OK** to continue.</span></span>

    <span data-ttu-id="5b8ad-666">![WebTest1 테스트 추가](maintainable-azure-websites-managing-change-and-scale/_static/image92.png "WebTest1 테스트 추가")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-666">![Adding the WebTest1 test](maintainable-azure-websites-managing-change-and-scale/_static/image92.png "Adding the WebTest1 test")</span></span>

    <span data-ttu-id="5b8ad-667">*WebTest1 테스트 추가*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-667">*Adding the WebTest1 test*</span></span>
15. <span data-ttu-id="5b8ad-668">다시 합니다 **테스트 조합** 페이지에서 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-668">Back in the **Test Mix** page, click **Next**.</span></span>

    <span data-ttu-id="5b8ad-669">![완료 테스트 조합 페이지](maintainable-azure-websites-managing-change-and-scale/_static/image93.png "완료 테스트 조합 페이지")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-669">![Completing the Test Mix page](maintainable-azure-websites-managing-change-and-scale/_static/image93.png "Completing the Test Mix page")</span></span>

    <span data-ttu-id="5b8ad-670">*완료 테스트 조합 페이지*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-670">*Completing the Test Mix page*</span></span>
16. <span data-ttu-id="5b8ad-671">에 **네트워크 조합** 페이지에서 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-671">In the **Network Mix** page, click **Next**.</span></span>

    <span data-ttu-id="5b8ad-672">![네트워크 조합 페이지에서 다음을 클릭 하면](maintainable-azure-websites-managing-change-and-scale/_static/image94.png "네트워크 조합 페이지에서 다음을 클릭 하면")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-672">![Clicking next in the Network Mix page](maintainable-azure-websites-managing-change-and-scale/_static/image94.png "Clicking next in the Network Mix page")</span></span>

    <span data-ttu-id="5b8ad-673">*네트워크 조합 페이지에서 다음을 클릭*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-673">*Clicking next in the Network Mix page*</span></span>
17. <span data-ttu-id="5b8ad-674">에 **브라우저 조합** 페이지에서 **Internet Explorer 10.0** 브라우저 종류와 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-674">In the **Browser Mix** page, select **Internet Explorer 10.0** as the browser type and click **Next**.</span></span>

    <span data-ttu-id="5b8ad-675">![브라우저 종류를 선택 하면](maintainable-azure-websites-managing-change-and-scale/_static/image95.png "브라우저 종류를 선택 합니다.")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-675">![Selecting the browser type](maintainable-azure-websites-managing-change-and-scale/_static/image95.png "Selecting the browser type")</span></span>

    <span data-ttu-id="5b8ad-676">*브라우저 종류를 선택합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-676">*Selecting the browser type*</span></span>
18. <span data-ttu-id="5b8ad-677">에 **카운터 집합** 페이지에서 클릭 **다음**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-677">In the **Counter Sets** page, click **Next**.</span></span>

    <span data-ttu-id="5b8ad-678">![카운터 집합 페이지에서 다음을 클릭](maintainable-azure-websites-managing-change-and-scale/_static/image96.png "카운터 집합 페이지에서 다음 클릭")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-678">![Clicking Next in the Counter Sets page](maintainable-azure-websites-managing-change-and-scale/_static/image96.png "Clicking Next in the Counter Sets page")</span></span>

    <span data-ttu-id="5b8ad-679">*카운터 집합 페이지에서 다음을 클릭합니다.*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-679">*Clicking Next in the Counter Sets page*</span></span>
19. <span data-ttu-id="5b8ad-680">에 **실행 설정** 페이지에서 설정 합니다 **부하 테스트 지속 시간** 를 **5 분** 클릭 **완료**.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-680">In the **Run Settings** page, set the **Load test duration** to **5 minutes** and click **Finish**.</span></span>

    <span data-ttu-id="5b8ad-681">![부하 테스트 지속 시간을 5 분으로 설정](maintainable-azure-websites-managing-change-and-scale/_static/image97.png "부하 테스트 지속 시간을 5 분으로 설정")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-681">![Setting the load test duration to 5 minutes](maintainable-azure-websites-managing-change-and-scale/_static/image97.png "Setting the load test duration to 5 minutes")</span></span>

    <span data-ttu-id="5b8ad-682">*부하 테스트 지속 시간을 5 분으로 설정*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-682">*Setting the load test duration to 5 minutes*</span></span>
20. <span data-ttu-id="5b8ad-683">**솔루션 탐색기**를 두 번 클릭 합니다 **Local.settings** 테스트 설정을 탐색 하는 파일입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-683">In **Solution Explorer**, double-click the **Local.settings** file to explore the test settings.</span></span> <span data-ttu-id="5b8ad-684">기본적으로 Visual Studio는 테스트를 실행 하려면 로컬 컴퓨터를 사용 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-684">By default, Visual Studio uses your local computer to run the tests.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-685">또는 사용 하 여 클라우드 부하 테스트를 실행 하려면 테스트 프로젝트를 구성할 수 있습니다 **VSO Visual Studio Online ()** 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-685">Alternatively, you can configure your test project to run the load tests in the cloud using **Visual Studio Online (VSO)**.</span></span> <span data-ttu-id="5b8ad-686">VSO는 클라우드 기반 부하 테스트를 좀 더 현실적인 로드를 시뮬레이션 하는 서비스, 네트워크 대역폭, CPU 용량 및 사용 가능한 메모리 등 로컬 환경 제약 조건을 방지를 제공 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-686">VSO provides a cloud-based load testing service that simulates a more realistic load, avoiding local environment constraints like CPU capacity, available memory and network bandwidth.</span></span> <span data-ttu-id="5b8ad-687">VSO를 사용 하 여 부하 테스트를 실행 하는 방법에 대 한 자세한 내용은 참조 하세요. [이 문서에서는](https://www.visualstudio.com/get-started/load-test-your-app-vs)합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-687">For more information about using VSO to run load tests, see [this article](https://www.visualstudio.com/get-started/load-test-your-app-vs).</span></span>

    ![테스트 설정](maintainable-azure-websites-managing-change-and-scale/_static/image98.png)

<a id="Ex5Task3"></a>
#### <a name="task-3--autoscale-verification"></a><span data-ttu-id="5b8ad-689">작업 3 – 자동 크기 조정 확인</span><span class="sxs-lookup"><span data-stu-id="5b8ad-689">Task 3 – Autoscale Verification</span></span>

<span data-ttu-id="5b8ad-690">이제 이전 태스크에서 만든 부하 테스트를 실행 하 고 웹 앱 부하 상태에서 어떻게 동작 하는지 확인 됩니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-690">You will now execute the load test you created in the previous task and see how your web app behaves under load.</span></span>

1. <span data-ttu-id="5b8ad-691">**솔루션 탐색기**를 두 번 클릭 **LoadTest1.loadtest** 를 부하 테스트를 엽니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-691">In **Solution Explorer**, double-click **LoadTest1.loadtest** to open the load test.</span></span>

    <span data-ttu-id="5b8ad-692">![LoadTest1.loadtest 열기](maintainable-azure-websites-managing-change-and-scale/_static/image99.png "LoadTest1.loadtest 열기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-692">![Opening LoadTest1.loadtest](maintainable-azure-websites-managing-change-and-scale/_static/image99.png "Opening LoadTest1.loadtest")</span></span>

    <span data-ttu-id="5b8ad-693">*열기 LoadTest1.loadtest*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-693">*Opening LoadTest1.loadtest*</span></span>
2. <span data-ttu-id="5b8ad-694">에 **LoadTest1.loadtest** 창에서 부하 테스트를 실행 하려면 도구 상자에서 첫 번째 단추를 클릭 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-694">In the **LoadTest1.loadtest** window, click the first button in the toolbox to run the load test.</span></span>

    <span data-ttu-id="5b8ad-695">![부하 테스트 실행](maintainable-azure-websites-managing-change-and-scale/_static/image100.png "부하 테스트 실행")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-695">![Running the load test](maintainable-azure-websites-managing-change-and-scale/_static/image100.png "Running the load test")</span></span>

    <span data-ttu-id="5b8ad-696">*부하 테스트 실행*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-696">*Running the load test*</span></span>
3. <span data-ttu-id="5b8ad-697">부하 테스트가 완료 될 때까지 기다립니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-697">Wait until the load test completes.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-698">부하 테스트는 동시에 웹 앱에 요청을 전송 하는 여러 사용자를 시뮬레이션 합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-698">The load test simulates multiple users that send requests to the web app simultaneously.</span></span> <span data-ttu-id="5b8ad-699">테스트를 실행 하는 경우에 모든 오류, 경고 또는 부하 테스트 실행에 관련 된 기타 정보를 검색 하려면 사용 가능한 카운터를 모니터링할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-699">When the test is running, you can monitor the available counters to detect any errors, warnings or other information related to your load test run.</span></span>

    <span data-ttu-id="5b8ad-700">![부하 테스트 실행](maintainable-azure-websites-managing-change-and-scale/_static/image101.png "부하 테스트가 완료 될 때까지 대기")</span><span class="sxs-lookup"><span data-stu-id="5b8ad-700">![Load test running](maintainable-azure-websites-managing-change-and-scale/_static/image101.png "Waiting until the load test completes")</span></span>

    <span data-ttu-id="5b8ad-701">*부하 테스트 실행*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-701">*Load test running*</span></span>
4. <span data-ttu-id="5b8ad-702">테스트가 완료 되 면 관리 포털로 돌아가서로 이동 합니다 **확장** 웹 앱의 페이지입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-702">Once the test completes, go back to the management portal and navigate to the **Scale** page of your web app.</span></span> <span data-ttu-id="5b8ad-703">아래는 **용량** 섹션인 표시 그래프의 새 인스턴스를 자동으로 배포 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-703">Under the **capacity** section, you should see in the graph that a new instance was automatically deployed.</span></span>

    ![새 인스턴스를 자동으로 배포](maintainable-azure-websites-managing-change-and-scale/_static/image102.png)

    <span data-ttu-id="5b8ad-705">*새 인스턴스를 자동으로 배포*</span><span class="sxs-lookup"><span data-stu-id="5b8ad-705">*New instance automatically deployed*</span></span>

    > [!NOTE]
    > <span data-ttu-id="5b8ad-706">변경 내용을 그래프에 표시 하려면 몇 분 정도 걸릴 수 있습니다 (키를 눌러 **ctrl+f5** 주기적으로 페이지를 새로).</span><span class="sxs-lookup"><span data-stu-id="5b8ad-706">It may take several minutes for the changes to appear in the graph (press **CTRL + F5** periodically to refresh the page).</span></span> <span data-ttu-id="5b8ad-707">모든 변경 내용이 표시 되지 않으면, 다음을 시도할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-707">If you do not see any changes, you can try the following:</span></span>
    > 
    > - <span data-ttu-id="5b8ad-708">부하 테스트 시간을 증가 시킬 (예: **10 분**)</span><span class="sxs-lookup"><span data-stu-id="5b8ad-708">Increase the duration of the load test (e.g. to **10 minutes**)</span></span>
    > - <span data-ttu-id="5b8ad-709">최대값과 최소값을 줄일 합니다 **대상 CPU** 웹 앱의 자동 크기 조정 구성의 범위</span><span class="sxs-lookup"><span data-stu-id="5b8ad-709">Reduce the maximum and minimum values of the **Target CPU** range in the Autoscale configuration of your web app</span></span>
    > - <span data-ttu-id="5b8ad-710">사용 하 여 클라우드에서 부하 테스트 실행 **Visual Studio Online**합니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-710">Run the load test in the cloud with **Visual Studio Online**.</span></span> <span data-ttu-id="5b8ad-711">자세한 내용은 [여기](https://www.visualstudio.com/get-started/load-test-your-app-vs.aspx)</span><span class="sxs-lookup"><span data-stu-id="5b8ad-711">More information [here](https://www.visualstudio.com/get-started/load-test-your-app-vs.aspx)</span></span>

* * *

<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="5b8ad-712">요약</span><span class="sxs-lookup"><span data-stu-id="5b8ad-712">Summary</span></span>

<span data-ttu-id="5b8ad-713">이 실습에서는 설정 하 고 응용 프로그램 Azure에서 프로덕션 웹 앱을 배포 하는 방법을 알아보았습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-713">In this hands-on lab, you learned how to set up and deploy your application to production web apps in Azure.</span></span> <span data-ttu-id="5b8ad-714">검색 하 고 사용 하 여 데이터베이스를 업데이트 하 여 시작 **Entity Framework Code First 마이그레이션을**를 사용 하 여 사이트의 새 버전을 배포 하 여 계속 **Git** 롤백 수행 하는 안정적인 최신 버전의 사이트입니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-714">You started by detecting and updating your databases using **Entity Framework Code First Migrations**, then continued by deploying new versions of your site using **Git** and performing rollbacks to the latest stable version of your site.</span></span> <span data-ttu-id="5b8ad-715">또한 Blob 컨테이너에 정적 콘텐츠를 이동 하려면 저장소를 사용 하 여 앱의 크기를 조정 하는 방법을 알아보았습니다.</span><span class="sxs-lookup"><span data-stu-id="5b8ad-715">Additionally, you learned how to scale your app using Storage to move your static content to a Blob container.</span></span>
