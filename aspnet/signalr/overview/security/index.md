...
====================
> 이해 하 고 SignalR 응용 프로그램의 보안 문제를 처리 합니다.


- [SignalR 보안 소개](introduction-to-security.md)
- [인증 및 권한 부여 SignalR 허브에 대 한](hub-authorization.md)
- [인증 및 권한 부여 SignalR 영구 연결에 대 한](persistent-connection-authorization.md)
