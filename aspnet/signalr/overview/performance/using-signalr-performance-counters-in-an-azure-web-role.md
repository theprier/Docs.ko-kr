...
3. 에 **새 프로젝트** 대화 상자에서를 **Visual C#** > **클라우드** 왼쪽의 범주를 선택한는 **Azure클라우드서비스** 템플릿. 앱의 이름을 **SignalRPerfCounters** 선택한 **확인**합니다.

   ![새 클라우드 응용 프로그램](using-signalr-performance-counters-in-an-azure-web-role/_static/image1.png)

   > [!NOTE]
   > 표시 되지 않는 경우는 **클라우드** 템플릿 범주 또는 **Azure 클라우드 서비스** 템플릿을 설치 해야 합니다 **Azure 개발** Visual Studio 2017에 대 한 워크 로드. 선택 합니다 **Visual Studio 설치 관리자 열기** 의 왼쪽 맨 아래에서 링크는 **새 프로젝트** Visual Studio 설치 관리자를 열려면 대화 상자. 선택 된 **Azure 개발** 워크 로드를 선택한 후 **수정** 워크 로드를 설치 하려면.
   >
...
21. 새 폴더를 만듭니다는 **WebRole1** 라는 프로젝트가 *Hubs*합니다. 마우스 오른쪽 단추로 클릭 합니다 *Hubs* 폴더에서 **솔루션 탐색기** 선택한 **추가** > **새 항목**합니다. 에 **새 항목 추가** 대화 상자를 선택 합니다 **웹** > **SignalR** 범주를 선택한 후는 **SignalR 허브 클래스 (v2)** 항목 템플릿. 새 허브의 이름을 *MyHub.cs* 선택한 **추가**합니다.
