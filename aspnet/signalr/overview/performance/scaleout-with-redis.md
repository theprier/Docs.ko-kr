...
1. <span data-ttu-id="d92f6-129">Redis를 설치 하 고 Redis 서버를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="d92f6-129">Install Redis and start the Redis server.</span></span>
