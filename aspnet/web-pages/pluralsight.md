...
"이에 대 한 Pluralsight Matt Milner에서 기록한 방법은 동적 데이터 기반 응용 프로그램에서 ASP.NET 웹 페이지 뿐만 아니라 강력한 새로운 Razor 구문은 구동 만들어야 할 모든 세부 정보를 가져올 수 있는 좋은 방법입니다. 이 무료 소스에 대 한 Pluralsight에 큰 감사! 비디오 플레이어, 내용 및 흐름은 실제로 완료 합니다. 확인해 지금 체크 아웃! "
