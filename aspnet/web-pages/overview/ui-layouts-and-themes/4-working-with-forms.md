...
1. <span data-ttu-id="6ad9a-132">맨 위에 있는 *Form.cshtml* 파일에서 다음 코드를 입력 합니다.</span><span class="sxs-lookup"><span data-stu-id="6ad9a-132">At the top of the *Form.cshtml* file, enter the following code:</span></span>
