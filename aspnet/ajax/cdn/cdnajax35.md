...
---
<a name="aspnet-ajax-35"></a><span data-ttu-id="87cfc-102">ASP.NET Ajax 3.5</span><span class="sxs-lookup"><span data-stu-id="87cfc-102">ASP.NET Ajax 3.5</span></span>
====================
<span data-ttu-id="87cfc-103">다음 파일은 CDN에서 호스트 됩니다.</span><span class="sxs-lookup"><span data-stu-id="87cfc-103">The following files are hosted on the CDN:</span></span>
