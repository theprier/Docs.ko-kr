...
---
<a name="jquery-datatables-192"></a><span data-ttu-id="93631-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="93631-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="93631-103">CDN에서 jQuery DataTables 플러그 인에 대 한 다음 파일이 호스팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="93631-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
