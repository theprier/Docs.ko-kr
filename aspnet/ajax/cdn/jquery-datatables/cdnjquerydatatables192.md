...
ms.locfileid: "30071358"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="fafdf-102">jQuery Datatable 1.9.2</span><span class="sxs-lookup"><span data-stu-id="fafdf-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="fafdf-103">JQuery Datatable 플러그 인에 대 한 다음 파일은 CDN에서 호스트 됩니다.</span><span class="sxs-lookup"><span data-stu-id="fafdf-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
