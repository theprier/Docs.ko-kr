...
ms.locfileid: "30070786"
---
<a name="jquery-validation-1150"></a><span data-ttu-id="0ce08-102">jQuery 유효성 검사 1.15.0</span><span class="sxs-lookup"><span data-stu-id="0ce08-102">jQuery Validation 1.15.0</span></span>
====================
<span data-ttu-id="0ce08-103">다음 파일은 CDN에서 호스트 됩니다.</span><span class="sxs-lookup"><span data-stu-id="0ce08-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="0ce08-104">파일에 지역화 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages \_# #.js 여기서 # # loc 코드입니다.</span><span class="sxs-lookup"><span data-stu-id="0ce08-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
