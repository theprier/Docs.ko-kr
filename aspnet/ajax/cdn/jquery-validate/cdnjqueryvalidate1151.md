...
ms.locfileid: "37817871"
---
<a name="jquery-validation-1151"></a><span data-ttu-id="664c6-102">jQuery 유효성 검사 1.15.1</span><span class="sxs-lookup"><span data-stu-id="664c6-102">jQuery Validation 1.15.1</span></span>
====================
<span data-ttu-id="664c6-103">다음 파일은 CDN에서 호스트 됩니다.</span><span class="sxs-lookup"><span data-stu-id="664c6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="664c6-104">파일에 지역화 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js 여기서 # # loc 코드입니다.</span><span class="sxs-lookup"><span data-stu-id="664c6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js where ## is the loc code.</span></span>
