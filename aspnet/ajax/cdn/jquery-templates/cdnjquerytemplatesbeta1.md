...
ms.locfileid: "37830175"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="f7737-102">jQuery 템플릿 베타 1</span><span class="sxs-lookup"><span data-stu-id="f7737-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="f7737-103">JQuery 템플릿 플러그 인에는 다음 파일이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="f7737-103">The jQuery Templates plugin includes the following files:</span></span>
