...
ms.locfileid: "41829064"
---
<a name="jquery-mobile-145-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="acd79-102">Microsoft Ajax CDN의 jQuery Mobile 1.4.5</span><span class="sxs-lookup"><span data-stu-id="acd79-102">jQuery Mobile 1.4.5 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="acd79-103">JQuery Mobile 1.4.5 라이브러리에는 다음 파일이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="acd79-103">The jQuery Mobile 1.4.5 library includes the following files:</span></span>
