...
ms.locfileid: "41828818"
---
<a name="jquery-mobile-142-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="f9f04-102">Microsoft Ajax CDN의 jQuery Mobile 1.4.2</span><span class="sxs-lookup"><span data-stu-id="f9f04-102">jQuery Mobile 1.4.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="f9f04-103">JQuery Mobile 1.4.2 라이브러리에는 다음 파일이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="f9f04-103">The jQuery Mobile 1.4.2 library includes the following files:</span></span>
