...
ms.locfileid: "37801633"
---
<a name="jquery-mobile-140-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="ffaff-102">Microsoft Ajax CDN의 jQuery Mobile 1.4.0</span><span class="sxs-lookup"><span data-stu-id="ffaff-102">jQuery Mobile 1.4.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="ffaff-103">JQuery Mobile 1.4.0 라이브러리에는 다음 파일이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="ffaff-103">The jQuery Mobile 1.4.0 library includes the following files:</span></span>
