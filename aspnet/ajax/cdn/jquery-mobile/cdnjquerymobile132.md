...
---
<a name="jquery-mobile-132-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="cb3e5-102">jQuery Mobile 1.3.2 Microsoft Ajax CDN에서</span><span class="sxs-lookup"><span data-stu-id="cb3e5-102">jQuery Mobile 1.3.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="cb3e5-103">JQuery Mobile 1.3.2 라이브러리에는 다음 파일이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="cb3e5-103">The jQuery Mobile 1.3.2 library includes the following files:</span></span>
