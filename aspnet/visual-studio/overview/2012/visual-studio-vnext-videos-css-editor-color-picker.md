...
이 비디오에서는 Mads Kristensen 현재 스프레드시트의 모든 색에 대 한 빠른 액세스를 제공 하 고 고급 색 선택기 스 포 이트 도구로 제공 하면 Visual Studio vNext CSS 편집기에서 색 선택 방법을 보여 줍니다.

[&#9654; (1 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/visual-studio-vnext-videos-css-editor-color-picker)
