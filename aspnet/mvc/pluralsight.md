...
---
<a name="mvc-video-training-from-pluralsight"></a>MVC Pluralsight의 비디오 교육
====================
### <a name="videos"></a>비디오
...
"이 MVC 5 과정에 대 한 Pluralsight K. Scott Allen에서 기록한 빠르게 속도 최신 버전의 ASP.NET MVC에는 훌륭한 방법을 제공 하는 데 사용 합니다. Scott의 표시 스타일 따르기가 쉽습니다 및 기술적으로 매력적인 이며 과정 형식, 비디오 플레이어 및 전반적인 흐름은 매우 큽니다. Plus – 무료, 하지 알아보려면 MVC 5 오늘 이유가 없습니다 이므로! "

Scott Guthrie, 임원 부사장, Microsoft 클라우드 및 엔터프라이즈 그룹, Microsoft


![pluralsight-로고-playbutton](pluralsight/_static/image1.png)

3000 + 개발에 대 한 액세스를 잠금 해제 IT 및 언제, 어디서 나 볼 수 있도록 창조적인 과정

**$ 29/mo.부터**[무료 평가판 시작](https://pluralsight.com/microsoft/OLT/subscribe/Subscribe1.aspx?freetrial=true&planHint=Monthly&utm_source=microsoft&utm_medium=sponsored-page&utm_content=aspdotnet-mvc5-fundamentals&utm_campaign=microsoft-sponsored-course) [지금 등록](https://pluralsight.com/microsoft/olt/subscriptions.aspx?utm_source=microsoft&utm_medium=sponsored-page&utm_content=aspdotnet-mvc5-fundamentals&utm_campaign=microsoft-sponsored-course)
