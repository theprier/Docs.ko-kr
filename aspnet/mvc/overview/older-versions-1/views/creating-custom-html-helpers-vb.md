...
**그림 01**: HTML 도우미를 사용 하 여 렌더링 된 페이지 ([큰 이미지를 보려면 클릭](creating-custom-html-helpers-vb/_static/image3.png))
...
**그림 02**: Html.Label() 확장 메서드를 사용 하 여 ([큰 이미지를 보려면 클릭](creating-custom-html-helpers-vb/_static/image6.png))
