...
**그림 01**: 캐시 시간 ([큰 이미지를 보려면 클릭](understanding-action-filters-vb/_static/image3.png))
...
**그림 02**: Visual Studio 출력 창에 작성 ([큰 이미지를 보려면 클릭](understanding-action-filters-vb/_static/image6.png))
