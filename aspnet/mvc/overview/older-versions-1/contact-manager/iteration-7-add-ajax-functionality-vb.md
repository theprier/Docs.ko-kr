...
[![만 연락처를 업데이트 하는 중](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**그림 01**:만 연락처를 업데이트 하는 중 ([큰 이미지를 보려면 클릭](iteration-7-add-ajax-functionality-vb/_static/image2.png))
...
**그림 02**: 삭제 확인 페이지 ([큰 이미지를 보려면 클릭](iteration-7-add-ajax-functionality-vb/_static/image4.png))
