...
title: '반복 추가 Ajax 기능 (C#) #7 – | Microsoft Docs'
author: microsoft
...
ms.locfileid: "30875528"
---
<a name="iteration-7--add-ajax-functionality-c"></a>반복 #7 – 추가 Ajax 기능 (C#)
====================
...
[![만 연락처를 업데이트합니다.](iteration-7-add-ajax-functionality-cs/_static/image1.jpg)](iteration-7-add-ajax-functionality-cs/_static/image1.png)

**그림 01**: 연락처만 업데이트 ([전체 크기 이미지를 보려면 클릭](iteration-7-add-ajax-functionality-cs/_static/image2.png))
...
**그림 02**: 삭제 확인 페이지 ([전체 크기 이미지를 보려면 클릭](iteration-7-add-ajax-functionality-cs/_static/image4.png))
