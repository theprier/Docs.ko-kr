...
**그림 01**: 새 프로젝트 대화 상자 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image2.png))
...
**그림 02**:의 단위 테스트 프로젝트 만들기 대화 상자 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image4.png))
...
**그림 03**:의 솔루션 탐색기 창 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image6.png))
...
**그림 04**: 새 Microsoft SQL Server Express 데이터베이스를 만드는 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image8.png))
...
**그림 05**: 데이터베이스 테이블 디자이너 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image10.png))
...
**그림 06**: 새 항목 추가 대화 상자 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image12.png))
...
**그림 07**: Model 콘텐츠 선택 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image14.png))
...
**그림 08**: 데이터 연결 선택 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image16.png))
...
**그림 09**: 데이터베이스 개체 선택 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image18.png))
...
**그림 10**: The 연락처 클래스 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image20.png))
...
**그림 11**: Home 컨트롤러 추가 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image22.png))
...
**그림 12**: 인덱스 뷰 추가 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image24.png))
...
**그림 13**: 뷰 추가 대화 상자 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image26.png))
...
**그림 14**: 디버깅 사용 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image28.png))
...
**그림 15**: The 인덱스 보기 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image30.png))
...
**그림 16**: 만들기 뷰 추가 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image32.png))
...
**그림 17**: 분해 하는 페이지가 표시 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image34.png))
...
**그림 18**: The Create View ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image36.png))
...
**그림 19**:는 편집 뷰 추가 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image38.png))
...
**그림 20**: 삭제 확인 보기로 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image40.png))
...
**그림 21**: 인덱스 편집 링크를 사용 하 여 뷰 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image42.png))
...
**그림 22**: 삭제 확인 보기로 추가 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image44.png))
...
**그림 23**: 컨트롤러 이름 리팩터링 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image46.png))
...
**그림 24**: 이름 바꾸기 대화 상자를 사용 하 여 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image48.png))
...
**그림 25**: 기본 컨트롤러 없음 ([큰 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image50.png))
