...
**그림 01**: LINQ to SQL 클래스 만들기 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image2.png))
...
**그림 02**:은 엔터티 데이터 모델 디자이너 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image4.png))
...
**그림 03**: 컨트롤러 메뉴 추가 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image6.png))
...
**그림 04**: 컨트롤러 추가 대화 상자 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image8.png))
...
목록 1에서 MoviesDBEntities 클래스 MoviesDB 데이터베이스를 나타내는 데 사용 됩니다. 이 클래스를 사용 하려면 다음과 같이 MvcApplication1.Models 네임 스페이스를 해야 합니다.
...
**그림 05**: 뷰 추가 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image10.png))
...
**그림 06**: 뷰 추가 대화 상자 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image12.png))
...
**그림 07**: 영화 테이블 ([큰 이미지를 보려면 클릭](displaying-a-table-of-database-data-cs/_static/image14.png))
...
보기 목록 4에 동영상의 모든 반복 되는 foreach 루프를 포함 합니다. 각 영화에 대 한 부분 MovieTemplate 동영상 서식을 지정 하는 데 사용 됩니다. MovieTemplate RenderPartial() 도우미 메서드를 호출 하 여 렌더링 됩니다.
