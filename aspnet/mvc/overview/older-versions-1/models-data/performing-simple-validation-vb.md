...
**그림 01**: 뷰 추가 ([큰 이미지를 보려면 클릭](performing-simple-validation-vb/_static/image2.png))


[![새 프로젝트 대화 상자](performing-simple-validation-vb/_static/image2.jpg)](performing-simple-validation-vb/_static/image3.png)

**그림 02**: 강력한 형식의 뷰 만들기 ([큰 이미지를 보려면 클릭](performing-simple-validation-vb/_static/image4.png))
...
**그림 03**: 문제가 있는 제출 The Create view ([큰 이미지를 보려면 클릭](performing-simple-validation-vb/_static/image6.png))
...
**그림 04**: Prebinding 유효성 검사 오류 ([큰 이미지를 보려면 클릭](performing-simple-validation-vb/_static/image8.png))
