...
---
<a name="understanding-models-views-and-controllers-vb"></a>이해 모델, 뷰 및 컨트롤러 (VB)
====================
...
**그림 01**: 새 프로젝트 대화 상자 ([전체 크기 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image2.png))
...
[![단위 테스트 대화 상자 만들기](understanding-models-views-and-controllers-vb/_static/image2.jpg)](understanding-models-views-and-controllers-vb/_static/image3.png)

**그림 02**: 단위 테스트 대화 상자 만들기 ([전체 크기 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image4.png))
...
Controllers 폴더를 확장 하면 AccountController.vb 라는 파일 및 HomeController.vb 이라는 파일로 표시 됩니다. Views 폴더를 확장 하면 홈 계정당 하나만 그리고 Shared 라는 세 개의 하위 폴더가 표시 됩니다. 홈 폴더를 확장 하면 About.aspx 및 Index.aspx (그림 3 참조) 라는 두 개의 추가 파일이 표시 됩니다. 이러한 파일은 기본 ASP.NET MVC 서식 파일에 포함 된 예제 응용 프로그램을 구성 합니다.
...
**그림 03**:의 솔루션 탐색기 창 ([전체 크기 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image6.png))
...
[![디버깅 해제 대화 상자](understanding-models-views-and-controllers-vb/_static/image4.jpg)](understanding-models-views-and-controllers-vb/_static/image7.png)

**그림 04**: 디버깅 사용 안 함 대화 상자 ([전체 크기 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image8.png))
...
**그림 05**: The 인덱스 페이지 ([전체 크기 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image10.png))
...
컨트롤러는 방금 클래스 (예: Visual Basic 또는 C# 클래스). 샘플 ASP.NET MVC 응용 프로그램 컨트롤러 폴더에 있는 HomeController.vb 라는 컨트롤러 포함 되어 있습니다. HomeController.vb 파일의 내용은 목록 2에 재현 되어 있습니다.
