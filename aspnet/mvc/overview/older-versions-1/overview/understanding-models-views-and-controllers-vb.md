...
---
<a name="understanding-models-views-and-controllers-vb"></a>모델, 뷰 및 컨트롤러 이해 (VB)
====================
...
**그림 01**: 새 프로젝트 대화 상자 ([큰 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image2.png))
...
**그림 02**: 단위 테스트 만들기 대화 상자 ([큰 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image4.png))
...
컨트롤러 폴더를 확장 하면 HomeController.vb 이라는 파일과 AccountController.vb 라는 파일로 표시 됩니다. Views 폴더를 확장 하는 경우 명명 된 계정에 홈 및 공유 하는 세 개의 하위 폴더 표시 됩니다. 홈 폴더를 확장 하면 About.aspx 및 Index.aspx (그림 3 참조) 라는 추가 파일 두 개가 표시 됩니다. 이러한 파일은 기본 ASP.NET MVC 템플릿 사용 하 여 포함 된 샘플 응용 프로그램을 구성 합니다.
...
**그림 03**:의 솔루션 탐색기 창 ([큰 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image6.png))
...
**그림 04**: 디버깅 사용 안 함 대화 상자 ([큰 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image8.png))
...
**그림 05**:은 인덱스 페이지 ([큰 이미지를 보려면 클릭](understanding-models-views-and-controllers-vb/_static/image10.png))
...
컨트롤러는 방금 클래스 (예를 들어, Visual Basic 또는 C# 클래스). 샘플 ASP.NET MVC 응용 프로그램 컨트롤러 폴더에 있는 HomeController.vb 라는 컨트롤러를 포함 합니다. HomeController.vb 파일의 내용은 나열 하는 2에서 재생성 됩니다.
