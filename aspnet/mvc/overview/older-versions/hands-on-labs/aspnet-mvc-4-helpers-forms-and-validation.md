...
### <a name="exercise-1-creating-the-store-manager-controller-and-its-index-view"></a>연습 1: 저장소 관리자 컨트롤러를 만들고 해당 인덱스 보기
...
### <a name="exercise-2-adding-an-html-helper"></a>연습 2:는 HTML 도우미를 추가합니다.

StoreManager 인덱스 페이지는 한 가지 잠재적인 문제가: 제목과 Artist 이름 속성은 모두 테이블 서식 지정에 충분 합니다. 이 연습에서 해당 텍스트를 자를 사용자 지정 HTML 도우미를 추가 하는 방법을 배웁니다.
...
### <a name="exercise-3-creating-the-edit-view"></a>편집 뷰를 만드는 연습 3:
...
### <a name="exercise-4-adding-a-create-view"></a>실습 4: 만들기 뷰 추가
...
### <a name="exercise-5-handling-deletion"></a>실습 5: 삭제 처리
