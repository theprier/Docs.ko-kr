...
2. 이동 하는 [Azure SendGrid 등록 페이지](https://go.microsoft.com/fwlink/?linkid=271033&clcid=0x409) 무료로 SendGrid 계정을 등록 하 고 있습니다. SendGrid를 구성 하려면 다음과 유사한 코드를 추가 합니다.
