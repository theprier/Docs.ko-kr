...
====================
> Entity Framework 6를 사용하여 ASP.NET MVC 5 응용 프로그램에서 데이터를 표시하고 편집하는 기본 사항입니다.
...
- [Async 및 저장된 프로시저](async-and-stored-procedures-with-the-entity-framework-in-an-asp-net-mvc-application.md)
