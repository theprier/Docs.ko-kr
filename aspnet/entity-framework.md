...
- [가져오기:](https://msdn.com/data/ee712906) 프로젝트에 추가 하 고이 강력한 O/RM. 활용 하 고 시작 합니다.
- [시작:](https://msdn.com/data/ee712907) 비디오에 대 한 가이드를 방문 하 고 데이터를 최대한 활용할 수 있도록 자습서 확인 합니다.
- [도움말 얻기:](https://msdn.com/data/hh913619) 및 전문가 로부터 도움을 받아 Stack Overflow에서 데이터 커뮤니티에 기여 하는 방법을 알아봅니다.
...
- [예제 응용 프로그램](https://code.msdn.microsoft.com/ASPNET-MVC-Application-b01a9fe8)
