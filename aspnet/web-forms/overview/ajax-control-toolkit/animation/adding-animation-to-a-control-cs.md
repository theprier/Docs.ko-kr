...
---
<a name="adding-animation-to-a-control-c"></a>애니메이션 컨트롤을 추가 (C#)
====================
...
[![패널은 옅은 색](adding-animation-to-a-control-cs/_static/image2.png)](adding-animation-to-a-control-cs/_static/image1.png)

패널은 페이딩 ([전체 크기 이미지를 보려면 클릭](adding-animation-to-a-control-cs/_static/image3.png))
