...
[![가능한 세 가지 애니메이션 중 하나: 패널의 넓은 가져옵니다.](picking-one-animation-out-of-a-list-cs/_static/image2.png)](picking-one-animation-out-of-a-list-cs/_static/image1.png)

가능한 세 가지 애니메이션 중 하나: 패널의 넓은 가져옵니다 ([전체 크기 이미지를 보려면 클릭](picking-one-animation-out-of-a-list-cs/_static/image3.png))
