...
[![마우스 클릭 컨트롤은 애니메이션 시작](animating-in-response-to-user-interaction-cs/_static/image2.png)](animating-in-response-to-user-interaction-cs/_static/image1.png)

마우스 클릭 컨트롤은 애니메이션 시작 ([전체 크기 이미지를 보려면 클릭](animating-in-response-to-user-interaction-cs/_static/image3.png))
