...
**그림 01**:의 HTML 편집기 ([큰 이미지를 보려면 클릭](how-do-i-use-the-html-editor-control-vb/_static/image2.png))
...
**그림 02**: 디자인, HTML 및 미리 보기 단추 ([큰 이미지를 보려면 클릭](how-do-i-use-the-html-editor-control-vb/_static/image4.png))
...
**그림 03**:의 HTML 편집기 컨트롤 ([큰 이미지를 보려면 클릭](how-do-i-use-the-html-editor-control-vb/_static/image6.png))
...
**그림 04**: HTML 편집기 사용 하 여 양식을 제출 ([큰 이미지를 보려면 클릭](how-do-i-use-the-html-editor-control-vb/_static/image8.png))
...
**그림 05**:는 HTML 편집기 사용자 지정 ([큰 이미지를 보려면 클릭](how-do-i-use-the-html-editor-control-vb/_static/image10.png))
