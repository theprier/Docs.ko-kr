...
[![accordion의 데이터가 데이터 원본에서 직접 제공](databinding-to-an-accordion-cs/_static/image2.png)](databinding-to-an-accordion-cs/_static/image1.png)

데이터 원본에서 직접는 accordion의 데이터를 가져옵니다 ([전체 크기 이미지를 보려면 클릭](databinding-to-an-accordion-cs/_static/image3.png))
