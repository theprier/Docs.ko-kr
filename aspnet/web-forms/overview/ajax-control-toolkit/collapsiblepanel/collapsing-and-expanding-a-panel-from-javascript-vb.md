...
[![패널의 상태를 변경 하는 세 번째 단추:에서 축소 하 여 코드 확장 되 고 뒤로](collapsing-and-expanding-a-panel-from-javascript-vb/_static/image2.png)](collapsing-and-expanding-a-panel-from-javascript-vb/_static/image1.png)
