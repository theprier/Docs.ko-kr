...
ms.locfileid: "30870780"
---
<a name="using-textboxwatermark-in-a-formview-c"></a>TextBoxWatermark FormView (C#)에서 사용 하 여
====================
...
[![Extender에서 제공 되는 필드에서 워터 마크](using-textboxwatermark-in-a-formview-cs/_static/image2.png)](using-textboxwatermark-in-a-formview-cs/_static/image1.png)

Extender에서 제공 되는 필드에서 워터 마크 ([전체 크기 이미지를 보려면 클릭](using-textboxwatermark-in-a-formview-cs/_static/image3.png))
