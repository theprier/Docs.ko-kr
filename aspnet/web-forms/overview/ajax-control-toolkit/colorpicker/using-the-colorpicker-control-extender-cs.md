...
**그림 01**: 명함을 만들기 위한 간단한 폼 ([큰 이미지를 보려면 클릭](using-the-colorpicker-control-extender-cs/_static/image2.png))
...
**그림 02**: The ColorPicker Control Extender ([큰 이미지를 보려면 클릭](using-the-colorpicker-control-extender-cs/_static/image4.png))
...
**그림 03**: extender 추가 ([큰 이미지를 보려면 클릭](using-the-colorpicker-control-extender-cs/_static/image6.png))
...
**그림 04**: Extender 마법사를 사용 하 여 컨트롤 extender를 선택 하면 ([큰 이미지를 보려면 클릭](using-the-colorpicker-control-extender-cs/_static/image8.png))
...
**그림 05**: 단추를 사용 하 여 색 선택 대화 상자 표시 ([큰 이미지를 보려면 클릭](using-the-colorpicker-control-extender-cs/_static/image10.png))
