...
> 이 자습서는 사용 하 여 비동기 ASP.NET Web Forms 응용 프로그램을 구축 하는 기초 업무량이 [Visual Studio Express 2012 for Web](https://www.microsoft.com/visualstudio/11), Microsoft Visual Studio의 무료 버전입니다. 사용할 수도 있습니다 [Visual Studio 2012](https://www.microsoft.com/visualstudio/11)합니다. 다음 섹션에서는이 자습서에 포함 됩니다.
> 
...
ASP.NET 비동기 페이지에 포함 해야 합니다는 [페이지](https://msdn.microsoft.com/library/ydy4x04a.aspx) 지시문은 `Async` 특성이 "true"로 설정 합니다. 다음 코드는 [페이지](https://msdn.microsoft.com/library/ydy4x04a.aspx) 지시문의 `Async` 특성이 "true"로 설정 된 *GizmosAsync.aspx* 페이지.
...
- [페이지](https://msdn.microsoft.com/library/ydy4x04a.aspx) 지시문 있어야는 `Async` 특성이 "true"로 설정 합니다.
...
- 비동기 [HttpClient](https://msdn.microsoft.com/library/system.net.http.httpclient(VS.110).aspx) 동기 대신 클래스로 [WebClient](https://msdn.microsoft.com/library/system.net.webclient.aspx) 클래스입니다.
...
메서드를 후크 `RegisterAsyncTask` 직후 실행 됩니다 [PreRender](https://msdn.microsoft.com/library/ms178472.aspx)합니다. 다음 코드와 같이 직접 async void 페이지 이벤트를 사용할 수 또한:
