...
AuthCookie로 HttpCookie dim FormsAuthentication.GetAuthCookie (UserName.Text, RememberMe.Checked) =
...
티켓으로 FormsAuthenticationTicket dim FormsAuthentication.Decrypt(authCookie.Value) =
