...
다음 두 자습서에서 훨씬 더 자세히 폼 인증에 읽기[폼 인증의 개요는](an-overview-of-forms-authentication-vb.md) 및 [폼 인증 구성 및 고급 항목](forms-authentication-configuration-and-advanced-topics-vb.md)합니다. 에 대 한 자세한 ASP 합니다. NET의 인증 옵션 참조 [ASP.NET 인증](https://msdn.microsoft.com/en-us/library/eeyk640h.aspx)합니다.
