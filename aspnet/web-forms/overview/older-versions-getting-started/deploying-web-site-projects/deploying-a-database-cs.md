...
**그림 1**: 책 검토 웹 응용 프로그램의 데이터베이스는 네 가지 테이블의 구성 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image3.jpg))
...
**그림 2**: The 기술 장르 페이지 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image6.jpg))


[![에 대 한 검토를 익힐 ASP.NET 3.5에서 24 시간](deploying-a-database-cs/_static/image8.jpg)](deploying-a-database-cs/_static/image7.jpg) 

**그림 3**:에 대 한 The 검토 *설명 직접 ASP.NET 3.5 24 시간 동안의* ([클릭 하 여 큰 이미지 보기](deploying-a-database-cs/_static/image9.jpg))
...
**그림 4**: 데이터베이스 탐색기 또는 서버 탐색기에서 데이터베이스를 찾아 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image12.jpg))
...
**그림 5**: The 데이터베이스 게시 마법사 시작 화면 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image15.jpg))
...
**그림 6**: The 데이터베이스 게시 마법사 시작 화면 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image18.jpg))
...
**그림 7**: 데이터베이스를 파일에 스크립트 또는 해당 웹 호스트 공급자에 직접 게시할 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image21.jpg))
...
**그림 8**: 게시 옵션 지정 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image24.jpg))
...
**그림 9**: 해당 웹 호스트 공급자가의 데이터베이스 서버에 연결 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image27.jpg))
...
**그림 10**: 해당 웹 호스트 공급자가의 데이터베이스 서버에 연결 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image30.jpg))
...
**그림 11**:의 데이터베이스 개체는 복제 된 프로덕션 데이터베이스에서 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image33.jpg))
...
**그림 12**: 개발 데이터베이스에서 동일한 데이터를 포함 하는 프로덕션 데이터베이스 ([큰 이미지를 보려면 클릭](deploying-a-database-cs/_static/image36.jpg))
