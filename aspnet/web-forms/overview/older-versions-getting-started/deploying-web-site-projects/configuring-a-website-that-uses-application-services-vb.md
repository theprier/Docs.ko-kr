...
title: 응용 프로그램 서비스 (VB)를 사용 하는 웹 사이트 구성 | Microsoft Docs
...
**그림 1**: 응용 프로그램 서비스에 대 한 SQL server 구성 선택 ([큰 이미지를 보려면 클릭](configuring-a-website-that-uses-application-services-vb/_static/image3.jpg))
...
**그림 2**: 도구와 데이터베이스의 연결 정보를 제공 합니다. ([큰 이미지를 보려면 클릭](configuring-a-website-that-uses-application-services-vb/_static/image6.jpg))
...
**그림 4**: 데이터베이스 개체를 프로덕션 데이터베이스에 추가 되었는지 확인 ([큰 이미지를 보려면 클릭](configuring-a-website-that-uses-application-services-vb/_static/image12.jpg))
...
**그림 5**: 관리자 수 있습니다 새 사용자 계정 만들기 ([큰 이미지를 보려면 클릭](configuring-a-website-that-uses-application-services-vb/_static/image15.jpg))
