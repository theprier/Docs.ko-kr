...
**그림 01**: 원 지역 페이지-기준 영역 현재 사용자 지정이 가능한 보여 줍니다 ([큰 이미지를 보려면 클릭](multiple-contentplaceholders-and-default-content-cs/_static/image3.png))
...
**그림 02**: 마스터 페이지의 왼쪽 열에는 각각의 ContentPlaceHolder 컨트롤로 추가 ([큰 이미지를 보려면 클릭](multiple-contentplaceholders-and-default-content-cs/_static/image6.png))
...
**그림 03**: The 왼쪽 열 이제 포함 페이지별 콘텐츠 아래에 뉴스 섹션 ([큰 이미지를 보려면 클릭](multiple-contentplaceholders-and-default-content-cs/_static/image9.png))
...
**그림 04**:에 대 한 디자인 뷰 `About.aspx` 표시는 `LeftColumnContent` ContentPlaceHolder ([클릭 하 여 큰 이미지 보기](multiple-contentplaceholders-and-default-content-cs/_static/image12.png))
...
**그림 05**: 콘텐츠 없음에 대해 렌더링 되는 `LeftColumnContent` ContentPlaceHolder ([클릭 하 여 큰 이미지 보기](multiple-contentplaceholders-and-default-content-cs/_static/image15.png))
...
**그림 06**: 로그인 컨트롤을 포함 하는 마스터 페이지 ([큰 이미지를 보려면 클릭](multiple-contentplaceholders-and-default-content-cs/_static/image18.png))
...
**그림 07**:의 로그인 페이지 Represses 합니다 `QuickLoginUI` ContentPlaceHolder의 기본 콘텐츠 ([클릭 하 여 큰 이미지 보기](multiple-contentplaceholders-and-default-content-cs/_static/image21.png))
...
**그림 08**: The Default에 대 한 콘텐츠를 `LeftColumnContent` 하 고 `QuickLoginUI` ContentPlaceHolders 표시 됩니다 ([클릭 하 여 큰 이미지 보기](multiple-contentplaceholders-and-default-content-cs/_static/image24.png))
