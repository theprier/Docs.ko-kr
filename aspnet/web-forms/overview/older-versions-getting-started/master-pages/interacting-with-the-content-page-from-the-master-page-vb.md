...
**그림 01**: 새 ASP.NET 페이지를 추가 합니다 `Admin` 폴더 ([클릭 하 여 큰 이미지 보기](interacting-with-the-content-page-from-the-master-page-vb/_static/image3.png))
...
**그림 02**: 새 SqlDataSource 컨트롤을 GridView 바인딩할 ([큰 이미지를 보려면 클릭](interacting-with-the-content-page-from-the-master-page-vb/_static/image6.png))
...
**그림 03**: SqlDataSource Northwind 데이터베이스를 사용 하도록 구성 ([큰 이미지를 보려면 클릭](interacting-with-the-content-page-from-the-master-page-vb/_static/image9.png))
...
**그림 05**: 각 제품 및 해당 가격 GridView에 나열 됩니다 ([큰 이미지를 보려면 클릭](interacting-with-the-content-page-from-the-master-page-vb/_static/image15.png))
...
**그림 06**: SqlDataSource를 사용 하 여 구성 합니다 `NorthwindConnectionString` ([클릭 하 여 큰 이미지 보기](interacting-with-the-content-page-from-the-master-page-vb/_static/image18.png))
...
**그림 07**: 설정 SqlDataSource `UpdateCommand` 속성 ([클릭 하 여 큰 이미지 보기](interacting-with-the-content-page-from-the-master-page-vb/_static/image21.png))
...
**그림 08**: 초기 가격 값 ([큰 이미지를 보려면 클릭](interacting-with-the-content-page-from-the-master-page-vb/_static/image24.png))
...
**그림 09**: The Just-Doubled 가격을 Gridview에 표시 됩니다 ([큰 이미지를 보려면 클릭](interacting-with-the-content-page-from-the-master-page-vb/_static/image27.png))
