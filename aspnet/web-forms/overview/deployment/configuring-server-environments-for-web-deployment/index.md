...
---
<a name="aspnet-4---enterprise-deployment-series-2-configuring-servers"></a>ASP.NET 4-서버를 구성 배포 시리즈 2 Enterprise
====================
> 이 자습서에서 한 번 클릭 하거나 자동화 된 지원, 웹 사이트 배포 및 서로 다른 다양 한 시나리오에는 게시에 대 한 서버 환경을 설정 하는 방법을 설명 합니다.


- [웹 배포에 대 한 서버 환경 구성](configuring-server-environments-for-web-deployment.md)
