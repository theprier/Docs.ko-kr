...
**그림 8**: 반환 되는 레코드는 표시 되도록 데이터의 두 번째 페이지 ([큰 이미지를 보려면 클릭](efficiently-paging-through-large-amounts-of-data-vb/_static/image10.png))
...
**그림 17**: 데이터, Ordered의 이름, 제품에는 사용 하 여 사용자 지정 페이징 페이징 ([큰 이미지를 보려면 클릭](efficiently-paging-through-large-amounts-of-data-vb/_static/image21.png))
...
**그림 18**: 정렬 되는 데이터에만 표시 현재 페이지 ([큰 이미지를 보려면 클릭](efficiently-paging-through-large-amounts-of-data-vb/_static/image24.png))
