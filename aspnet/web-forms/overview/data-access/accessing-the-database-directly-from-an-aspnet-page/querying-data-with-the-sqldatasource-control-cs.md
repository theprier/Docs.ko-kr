...
**그림 10**:는 GridView를 추가 하 고 SqlDataSource 컨트롤에 바인딩할 ([전체 크기 이미지를 보려면 클릭](querying-data-with-the-sqldatasource-control-cs/_static/image14.gif))
