...
[![사용 하는 경우는 [ 생성 된 선언적 구문에서 생략 됩니다 디자이너에서 컬렉션 편집기를 ![ 와 같은 선언적 태그를 만들 빈 문자열로 할당 된 경우 설정을 완전히: ](customizing-the-datalist-s-editing-interface-vb/_static/image11.png)](customizing-the-datalist-s-editing-interface-vb/_static/image10.png)합니다.](customizing-the-datalist-s-editing-interface-vb/_static/image11.png)](customizing-the-datalist-s-editing-interface-vb/_static/image10.png)
...
[![범주 및 공급 업체 Dropdownlist 포함 (None) 옵션](customizing-the-datalist-s-editing-interface-vb/_static/image14.png)](customizing-the-datalist-s-editing-interface-vb/_static/image13.png)

**그림 10**: 합니다 `CategoriesDataSource` 하 고 [ Dropdownlist를 포함 하는 (없음) 옵션 (](customizing-the-datalist-s-editing-interface-vb/_static/image15.png)클릭 하 여 큰 이미지 보기)


[![데이터베이스 옵션 (없음)을 저장할 [ 값을 반환 해야 하는 ![ 이벤트 처리기입니다.](customizing-the-datalist-s-editing-interface-vb/_static/image17.png)](customizing-the-datalist-s-editing-interface-vb/_static/image16.png)

**변경 합니다 **하 고** 변수를 null 허용 정수 여야 하 고 할당할 값 이외의 [ 경우에만 DropDownList의 ](customizing-the-datalist-s-editing-interface-vb/_static/image18.png) 빈 문자열이 아닙니다:
