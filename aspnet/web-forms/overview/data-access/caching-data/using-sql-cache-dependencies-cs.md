...
**그림 5**: 명명 된 새 ObjectDataSource 만들려면 `ProductsDataSourceDeclarative` ([클릭 하 여 큰 이미지 보기](using-sql-cache-dependencies-cs/_static/image4.png))
