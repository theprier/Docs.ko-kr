...
**그림 10**: 합니다 `ProductsDataSourceDeclarative` 하 고 [ Dropdownlist를 포함 하는 (없음) 옵션 (](using-sql-cache-dependencies-cs/_static/image4.png)클릭 하 여 큰 이미지 보기)
...
**그림 6**: 세 개의 입력 매개 변수를 사용 하 여 UpdateProduct 오버 로드를 사용 하 여 ([큰 이미지를 보려면 클릭](using-sql-cache-dependencies-cs/_static/image6.png))
...
**그림 7**: (None) 드롭다운 목록을 삽입 및 삭제 하는 탭에 대 한 설정 ([큰 이미지를 보려면 클릭](using-sql-cache-dependencies-cs/_static/image8.png))
...
**그림 8**: The ObjectDataSource s `Selecting` 이벤트가 발생 합니다. 각 시간 페이징 되는 GridView, 편집, Sorted ([클릭 하 여 큰 이미지 보기](using-sql-cache-dependencies-cs/_static/image10.png))
...
**그림 9**:에서 지원 캐싱을 사용 하 여 SQL 캐시 종속성 ObjectDataSource 구성 `Products` 하 고 `Categories` ([클릭 하 여 큰 이미지 보기](using-sql-cache-dependencies-cs/_static/image12.png))
...
**그림 10**: 캐시 제품 데이터를 제거 제품 테이블 수정 ([큰 이미지를 보려면 클릭](using-sql-cache-dependencies-cs/_static/image14.png))
...
**그림 11**: ObjectDataSource 사용 하도록 구성 된 `ProductsCL` 클래스 ([클릭 하 여 큰 이미지 보기](using-sql-cache-dependencies-cs/_static/image16.png))
...
**그림 12**: 선택 된 `GetProducts` 선택 탭의 드롭 다운 목록에서에서 메서드 ([클릭 하 여 큰 이미지 보기](using-sql-cache-dependencies-cs/_static/image18.png))
...
**그림 13**: UpdateProduct 메서드와 같이 업데이트 탭의 드롭 다운 목록에서에서 선택 ([큰 이미지를 보려면 클릭](using-sql-cache-dependencies-cs/_static/image20.png))
