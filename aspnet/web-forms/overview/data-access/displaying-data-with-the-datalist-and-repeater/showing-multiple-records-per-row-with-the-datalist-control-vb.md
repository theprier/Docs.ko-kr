...
---
<a name="showing-multiple-records-per-row-with-the-datalist-control-vb"></a>DataList 컨트롤 (VB)를 사용 하 여 행 마다 여러 레코드 표시
====================
...
**그림 1**: The DataList 표시 제품이 행당 ([큰 이미지를 보려면 클릭](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image3.png))
...
**그림 2**: 기본적으로, 단일 열을 다중 행 테이블으로 DataList 렌더링 ([큰 이미지를 보려면 클릭](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image6.png))
...
**그림 3**: 합니다 `RepeatDirection` 속성은 아웃 레이아웃 방향 DataList의 항목 하는 방법을 나타냅니다 ([클릭 하 여 큰 이미지 보기](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image9.png))
...
**그림 4**:에 대 한 충분히 큰 데이터 원본, 단일 열 DataList는 필요한 가로 스크롤 ([큰 이미지를 보려면 클릭](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image12.png))
...
**그림 5**: 행당 제품이 표시 됩니다 ([큰 이미지를 보려면 클릭](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image15.png))
...
**그림 6**: 여기에서 제품은 세로로 배치 아웃 ([큰 이미지를 보려면 클릭](showing-multiple-records-per-row-with-the-datalist-control-vb/_static/image18.png))
