...
**그림 1**: 각 범주에서 제품을 함께 나열 됩니다 ([큰 이미지를 보려면 클릭](nested-data-web-controls-cs/_static/image3.png))
...
**그림 2**: 새 ObjectDataSource의 이름을 `CategoriesDataSource` ([클릭 하 여 큰 이미지 보기](nested-data-web-controls-cs/_static/image6.png))
...
**그림 4**: 각 범주 이름 및 설명을 나열 되어 단락 구분선으로 구분 된 ([큰 이미지를 보려면 클릭](nested-data-web-controls-cs/_static/image12.png))
...
**그림 5**: The 외부 Repeater 나열 각 범주; 내부 하나는 해당 범주에 대 한 제품 ([큰 이미지를 보려면 클릭](nested-data-web-controls-cs/_static/image15.png))
