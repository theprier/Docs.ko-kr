...
이 비디오에서 만들고 업데이트 하 고 관계 및 행 및 열 사용자 지정 유효성 검사를 통한 업데이트 LINQ, 단순 트랜잭션을 통해 레코드를 삭제 하는 방법을 설명 했습니다.

[&#9654; (17 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-linq-to-sql-updating-the-database)
