...
이 비디오에서는 전체 열 스 캐 폴딩을 사용 되지만 여전히 사용자 인터페이스에 표시 하지 않으려면 테이블 열을 제외 하는 방법을 볼 수 있습니다.

[&#9654;(5 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-to-remove-columns-from-your-dynamicdata-data-grids)
