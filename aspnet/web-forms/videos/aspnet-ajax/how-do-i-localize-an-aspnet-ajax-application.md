...
이 비디오에서는 표준 ASP.NET 프레임 워크의 지역화 기능 개요를 시작 하 고 ASP.NET AJAX Extensions의 지역화 기능을 확인 합니다. 에서는 어떻게 텍스트, 날짜 및 숫자 방법은 브라우저의 언어 설정에 따라 클라이언트를 지역화할 수 것에 대해 설명 합니다. 또한 AJAX 응용 프로그램을 만들 수 있습니다 하는 방법을 배울 정적 및 포함 된 리소스 서버를 다시 사용 합니다.

[&#9654;비디오 (28 분)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-localize-an-aspnet-ajax-application)
