...
---
<a name="working-with-iis7-delegated-admin"></a>IIS7 작업 관리 위임
====================
으로 [Joe Stagner](https://github.com/JoeStagner)

이 비디오에서는 IIS7 관리자 용으로 작성 된 흥미로운 새 원격 관리 기능을 소개 합니다. 서버와 클라이언트 구성 뿐 아니라 두 개의 권한 부여 옵션을 보여 줍니다.

[&#9654;(22 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/working-with-iis7-deligated-admin)
