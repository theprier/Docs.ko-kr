...
이 비디오에서 Chris Pels 데이터 사이의 중간 계층 바인딩된 사용자로는 ObjectDataSource를 사용 하는 방법을 표시 됩니다 인터페이스 요소와 사용자 지정 데이터는 비즈니스 개체에 대 한 클래스에 액세스 합니다. ObjectDataSource GUI 디자인 모드에서 그리고 선언적으로.aspx 페이지의 소스 뷰에서 용도 설명 합니다. 또한 ObjectDataSource에서 사용 하도록 데이터 액세스 클래스 및 비즈니스 개체의 디자인에 대 한 고려 사항은 다룹니다.

[&#9654; (32 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-use-the-objectdatasource-with-a-data-access-class-and-business-object)
