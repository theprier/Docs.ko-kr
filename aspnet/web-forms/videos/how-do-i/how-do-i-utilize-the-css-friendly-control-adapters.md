...
CSS 친숙 한 컨트롤 어댑터 표준 ASP.NET 2.0 서버 컨트롤에서 렌더링 되는 HTML을 변경할 수 있습니다. 이 비디오에서는 표준 ASP.NET 메뉴 컨트롤을 HTML 렌더링 배울 `<table>` 요소를 동일한 컨트롤은 HTML을 렌더링 하는 데 CSS 친숙 한 컨트롤 어댑터와 함께 `<ul>` 목록 요소를 메뉴의 내게 필요한 옵션 및 프레젠테이션을 향상 합니다. 
