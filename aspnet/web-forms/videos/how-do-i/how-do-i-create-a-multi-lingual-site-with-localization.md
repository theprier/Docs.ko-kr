...
추가 코드 없이 문화권 인식 및 로캘 특정 웹 콘텐츠를 만드는 방법에 알아봅니다. 리소스 편집기를 사용 하 여 페이지 수준 및 응용 프로그램 수준의 리소스를 만듭니다.

[&#9654; (13 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-create-a-multi-lingual-site-with-localization)
