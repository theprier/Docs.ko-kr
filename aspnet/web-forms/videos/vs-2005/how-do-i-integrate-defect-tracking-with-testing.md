...
---
<a name="how-do-i-integrate-defect-tracking-with-testing"></a>[어떻게 할까요?] 오류 추적 테스트와 통합 되나요?
====================
으로 [Chris Menegay](https://twitter.com/CMenegay)

이 비디오에서는 살펴보면는 테스트 프레임 워크의 Visual Studio Team System 및 작업 항목 추적 시스템 간의 통합 지점입니다.

[&#9654;(8 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-integrate-defect-tracking-with-testing)
