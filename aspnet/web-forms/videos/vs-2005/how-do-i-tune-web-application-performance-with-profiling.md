...
이 비디오에서는 Visual Studio Team System 웹 응용 프로그램을 프로 파일링의 두 메서드는 배울: 샘플링 및 계측 합니다. 개발자는 전체 호출 트리 및 응용 프로그램의 성능을 조정 하는 데 개체 할당을 포함 하는 응용 프로그램의 실행 세부 정보를 볼 수 있도록 계측 기본 코드에서 마커를 삽입 합니다.
