...
ms.locfileid: "26524992"
---
<a name="session-level-objects"></a>세션 수준 개체
====================
으로 [Joe Stagner](https://github.com/JoeStagner)

이 비디오에서는 세션 수준 이벤트 및 개체와 해당 응용 프로그램 및 페이지 수준 하에서의 사용을 비교 합니다.

[&#9654; (10 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/session-level-objects)
