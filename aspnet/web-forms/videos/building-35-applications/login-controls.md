...
---
<a name="login-controls"></a>Login 컨트롤
====================
으로 [Joe Stagner](https://github.com/JoeStagner)

이 비디오 Joe에는 소개 ASP.NET 멤버 자격 asp.net에서 Login 컨트롤 중 일부를 사용 하는 방법을 보여 줍니다.

[&#9654; (10 분) 비디오를 시청 하세요](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/login-controls)
