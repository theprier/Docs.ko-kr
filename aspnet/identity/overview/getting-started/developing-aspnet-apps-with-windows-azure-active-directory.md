...
3. Azure 계정입니다. [여기를 클릭](https://azure.microsoft.com/pricing/free-trial/) 무료 평가판 계정을 이미 있는 하지 않는 경우.
...
다음 단계를 사용 하 여 [Visual Studio Express 2013 for Web](https://www.microsoft.com/download/details.aspx?id=40747),으로 이루어지며 [Visual Studio 2013 업데이트 3](https://www.microsoft.com/download/details.aspx?id=43721)합니다.
...
[Graph API](https://msdn.microsoft.com/library/azure/hh974476.aspx) 는 Azure AD 디렉터리의 CRUD 및 개체에 다른 작업을 수행 하는 데 프로그래밍 인터페이스입니다. Visual Studio 2013에서 새 프로젝트를 만들 때 인증에 대 한 조직 계정 옵션을 선택 하는 경우 응용 프로그램 이미 Graph API를 호출 하 여 구성 됩니다. 이 섹션 간단 하 게에서는 Graph API의 작동 방식입니다.
...
- [Azure AD 그래프 API 개요](https://msdn.microsoft.com/library/azure/hh974476.aspx)
