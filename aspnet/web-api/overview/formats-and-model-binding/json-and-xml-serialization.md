...
- &quot;옵트인&quot; 방법: 속성 및 필드는 기본적으로 serialize 되지 않습니다. 속성 또는 필드를 serialize 하려면 데코 레이트 하는 **DataMember** 특성입니다.
...
다른 옵션은 모델 클래스의 특성을 방지 하려는 경우: 새 형식별 만들기 **DataContractSerializer** 인스턴스 및 설정 *preserveObjectReferences* 에 **true**  생성자에서. XML 미디어 유형 포맷터에서 형식당 하나의 serializer로이 인스턴스를 설정 합니다. 다음 코드에는이 작업을 수행 하는 방법을 보여 줍니다.
